...
final class UHDmoviesProviderPlugin$Companion$getDomains$1 extends ContinuationImpl {
    ...
    final /* synthetic */ UHDmoviesProviderPlugin.Companion this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    UHDmoviesProviderPlugin$Companion$getDomains$1(UHDmoviesProviderPlugin.Companion companion, Continuation<? super UHDmoviesProviderPlugin$Companion$getDomains$1> continuation) {
        super(continuation);
