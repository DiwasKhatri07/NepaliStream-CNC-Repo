...
final class TorraStreamAnime$buildMeteorUrl$preferredLanguages$1$1 extends SuspendLambda implements Function2<String, Continuation<? super JSONArray>, Object> {
    ...
    TorraStreamAnime$buildMeteorUrl$preferredLanguages$1$1(JSONArray jSONArray, Continuation<? super TorraStreamAnime$buildMeteorUrl$preferredLanguages$1$1> continuation) {
        super(2, continuation);
        this.$this_apply = jSONArray;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> torraStreamAnime$buildMeteorUrl$preferredLanguages$1$1 = new TorraStreamAnime$buildMeteorUrl$preferredLanguages$1$1(this.$this_apply, continuation);
        torraStreamAnime$buildMeteorUrl$preferredLanguages$1$1.L$0 = obj;
        return torraStreamAnime$buildMeteorUrl$preferredLanguages$1$1;
    }
