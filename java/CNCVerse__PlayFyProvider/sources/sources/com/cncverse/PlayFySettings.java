...
/* JADX INFO: compiled from: PlayFySettings.kt */
/* JADX INFO: loaded from: /home/ubuntu/work/NepaliStream-CNC-Repo/decoded/cncverse/PlayFyProvider/classes.dex */
@Metadata(d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010!\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B'\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007¢\u0006\u0004\b\t\u0010\nJ\f\u0010\r\u001a\u00020\u000e*\u00020\u000fH\u0002J\u0012\u0010\u0010\u001a\u0004\u0018\u00010\u00112\u0006\u0010\u0012\u001a\u00020\bH\u0003J\u0012\u0010\u0013\u001a\u0004\u0018\u00010\b2\u0006\u0010\u0012\u001a\u00020\bH\u0003J%\u0010\u0014\u001a\u0004\u0018\u0001H\u0015\"\b\b\u0000\u0010\u0015*\u00020\u000f*\u00020\u000f2\u0006\u0010\u0012\u001a\u00020\bH\u0003¢\u0006\u0002\u0010\u0016J&\u0010\u0017\u001a\u0004\u0018\u00010\u000f2\u0006\u0010\u0018\u001a\u00020\u00192\b\u0010\u001a\u001a\u0004\u0018\u00010\u001b2\b\u0010\u001c\u001a\u0004\u0018\u00010\u001dH\u0017J\u001a\u0010\u001e\u001a\u00020\u000e2\u0006\u0010\u001f\u001a\u00020\u000f2\b\u0010\u001c\u001a\u0004\u0018\u00010\u001dH\u0017J\b\u0010 \u001a\u00020\u000eH\u0002J\u0010\u0010!\u001a\u00020\"2\u0006\u0010#\u001a\u00020\bH\u0002R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0004\u001a\u0004\u0018\u00010\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\b0\fX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006$"}, d2 = {"Lcom/cncverse/PlayFySettings;", "Lcom/google/android/material/bottomsheet/BottomSheetDialogFragment;", "plugin", "Lcom/cncverse/PlayFyPlugin;", "sharedPref", "Landroid/content/SharedPreferences;", "playlistNames", "", "", "<init>", "(Lcom/cncverse/PlayFyPlugin;Landroid/content/SharedPreferences;Ljava/util/List;)V", "enabledPlaylists", "", "makeTvCompatible", "", "Landroid/view/View;", "getDrawable", "Landroid/graphics/drawable/Drawable;", "name", "getString", "findViewByName", "T", "(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;", "onCreateView", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "onViewCreated", "view", "restartApp", "getPlaylistRow", "Landroid/widget/RelativeLayout;", "playlistName", "PlayFyProvider_debug"}, k = 1, mv = {2, 3, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nPlayFySettings.kt\nKotlin\n*S Kotlin\n*F\n+ 1 PlayFySettings.kt\ncom/cncverse/PlayFySettings\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,148:1\n777#2:149\n873#2,2:150\n1915#2,2:153\n1915#2,2:155\n1#3:152\n*S KotlinDebug\n*F\n+ 1 PlayFySettings.kt\ncom/cncverse/PlayFySettings\n*L\n29#1:149\n29#1:150,2\n86#1:153,2\n91#1:155,2\n*E\n"})
public final class PlayFySettings extends BottomSheetDialogFragment {
    ...
    @NotNull
    private final PlayFyPlugin plugin;

    @Nullable
    private final SharedPreferences sharedPref;

    public PlayFySettings(@NotNull PlayFyPlugin plugin, @Nullable SharedPreferences sharedPref, @NotNull List<String> list) {
        this.plugin = plugin;
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (saveBtn != null) {
            saveBtn.setOnClickListener(new View.OnClickListener() { // from class: com.cncverse.PlayFySettings$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    PlayFySettings.onViewCreated$lambda$1(this.f$0, view2);
                }
            });
        }
    }
    ...
    public static final void onViewCreated$lambda$1(final PlayFySettings this$0, View it) {
        ...
        new AlertDialog.Builder(this$0.requireContext()).setTitle("Restart Required").setMessage("Changes have been saved. Do you want to restart the app to apply them?").setPositiveButton("Yes", new DialogInterface.OnClickListener() { // from class: com.cncverse.PlayFySettings$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                PlayFySettings.onViewCreated$lambda$1$1(this.f$0, dialogInterface, i);
            }
        }).setNegativeButton("No", new DialogInterface.OnClickListener() { // from class: com.cncverse.PlayFySettings$$ExternalSyntheticLambda3
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                PlayFySettings.onViewCreated$lambda$1$2(dialogInterface, i);
            }
        }).show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onViewCreated$lambda$1$1(PlayFySettings this$0, DialogInterface dialogInterface, int i) {
        this$0.dismiss();
        this$0.restartApp();
    }
    ...
    private final RelativeLayout getPlaylistRow(final String playlistName) {
        ...
        row.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
        ...
        cb.setLayoutParams($this$getPlaylistRow_u24lambda_u241_u240);
        TextView tv = new TextView(requireContext());
        tv.setId(View.generateViewId());
        tv.setText(StringsKt.substringAfter$default(playlistName, "playlist_", (String) null, 2, (Object) null));
        tv.setTextSize(16.0f);
        RelativeLayout.LayoutParams $this$getPlaylistRow_u24lambda_u242_u240 = new RelativeLayout.LayoutParams(-2, -2);
        $this$getPlaylistRow_u24lambda_u242_u240.addRule(17, cb.getId());
        $this$getPlaylistRow_u24lambda_u242_u240.addRule(15);
        $this$getPlaylistRow_u24lambda_u242_u240.setMarginStart(16);
        tv.setLayoutParams($this$getPlaylistRow_u24lambda_u242_u240);
        cb.setChecked(this.enabledPlaylists.contains(playlistName));
        cb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.cncverse.PlayFySettings$$ExternalSyntheticLambda0
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                PlayFySettings.getPlaylistRow$lambda$3(this.f$0, playlistName, compoundButton, z);
            }
        });
        tv.setOnClickListener(new View.OnClickListener() { // from class: com.cncverse.PlayFySettings$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PlayFySettings.getPlaylistRow$lambda$4(cb, view);
            }
        });
        row.addView(cb);
        row.addView(tv);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void getPlaylistRow$lambda$3(PlayFySettings this$0, String $playlistName, CompoundButton compoundButton, boolean checked) {
        List<String> list = this$0.enabledPlaylists;
        if (checked) {
            list.add($playlistName);
        } else {
            list.remove($playlistName);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void getPlaylistRow$lambda$4(CheckBox $cb, View it) {
