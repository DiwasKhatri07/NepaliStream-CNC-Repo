...
public final class DonationManager {
    ...
    public final void checkAndShow(@NotNull String providerName) {
        ...
        synchronized (gateLock) {
            ...
            BuildersKt.launch$default(scope, (CoroutineContext) null, (CoroutineStart) null, new C00132(activity, providerName, null), 3, (Object) null);
        }
    }
    ...
    static final class C00132 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C00132(AppCompatActivity appCompatActivity, String str, Continuation<? super C00132> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C00132(this.$activity, this.$providerName, continuation);
        }
    ...
    public final void showNow(@NotNull String providerName) {
        ...
        BuildersKt.launch$default(scope, (CoroutineContext) null, (CoroutineStart) null, new C00141(activity, providerName, null), 3, (Object) null);
    }
