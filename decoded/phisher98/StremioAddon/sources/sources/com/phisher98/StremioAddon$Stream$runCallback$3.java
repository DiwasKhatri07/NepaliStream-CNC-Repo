...
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n"}, d2 = {"<anonymous>", "", "sub", "Lcom/phisher98/StremioAddon$Subtitle;"}, k = 3, mv = {2, 4, 0}, xi = 48)
@DebugMetadata(c = "com.phisher98.StremioAddon$Stream$runCallback$3", f = "StremioAddon.kt", i = {0}, l = {361}, m = "invokeSuspend", n = {"sub"}, nl = {360}, s = {"L$0"}, v = 2)
final class StremioAddon$Stream$runCallback$3 extends SuspendLambda implements Function2<StremioAddon.Subtitle, Continuation<? super Unit>, Object> {
    ...
    StremioAddon$Stream$runCallback$3(Function1<? super SubtitleFile, Unit> function1, Continuation<? super StremioAddon$Stream$runCallback$3> continuation) {
        super(2, continuation);
        this.$subtitleCallback = function1;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> stremioAddon$Stream$runCallback$3 = new StremioAddon$Stream$runCallback$3(this.$subtitleCallback, continuation);
        stremioAddon$Stream$runCallback$3.L$0 = obj;
        return stremioAddon$Stream$runCallback$3;
    }

    public final Object invoke(StremioAddon.Subtitle subtitle, Continuation<? super Unit> continuation) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        StremioAddon.Subtitle sub = (StremioAddon.Subtitle) this.L$0;
