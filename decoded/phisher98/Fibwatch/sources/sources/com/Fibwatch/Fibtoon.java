...
public final class Fibtoon extends Fibwatch {
    ...
    @NotNull
    private final Set<TvType> supportedTypes = SetsKt.setOf(new TvType[]{TvType.AnimeMovie, TvType.Anime});
