...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0016¨\u0006\b"}, d2 = {"Lcom/phisher98/XDMoviesCFBypassInterceptor;", "Lokhttp3/Interceptor;", "<init>", "()V", "intercept", "Lokhttp3/Response;", "chain", "Lokhttp3/Interceptor$Chain;", "XDMovies"}, k = 1, mv = {2, 4, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nXDMovies.kt\nKotlin\n*S Kotlin\n*F\n+ 1 XDMovies.kt\ncom/phisher98/XDMoviesCFBypassInterceptor\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,538:1\n1739#2:539\n1814#2,3:540\n777#2:543\n873#2,2:544\n1739#2:546\n1814#2,3:547\n777#2:550\n873#2,2:551\n*S KotlinDebug\n*F\n+ 1 XDMovies.kt\ncom/phisher98/XDMoviesCFBypassInterceptor\n*L\n74#1:539\n74#1:540,3\n75#1:543\n75#1:544,2\n76#1:546\n76#1:547,3\n76#1:550\n76#1:551,2\n*E\n"})
public final class XDMoviesCFBypassInterceptor implements Interceptor {

    @NotNull
    public static final XDMoviesCFBypassInterceptor INSTANCE = new XDMoviesCFBypassInterceptor();

    private XDMoviesCFBypassInterceptor() {
    }
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) {
        ...
        String savedUa2 = XDMoviesProvider.INSTANCE.getCfUserAgent();
        if (savedUa2.length() > 0) {
            builder.header("User-Agent", savedUa2);
        }
        String savedCookies2 = XDMoviesProvider.INSTANCE.getCfCookies();
