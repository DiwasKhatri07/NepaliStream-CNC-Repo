...
@DebugMetadata(c = "com.AniVortex.AniVortexProvider$getMainPage$3$ottDef$1$deferredList$9", f = "AniVortexProvider.kt", i = {}, l = {108}, m = "invokeSuspend", n = {}, nl = {-1}, s = {}, v = 2)
final class AniVortexProvider$getMainPage$3$ottDef$1$deferredList$9 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super HomePageList>, Object> {
    int label;
    final /* synthetic */ AniVortexProvider this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AniVortexProvider$getMainPage$3$ottDef$1$deferredList$9(AniVortexProvider aniVortexProvider, Continuation<? super AniVortexProvider$getMainPage$3$ottDef$1$deferredList$9> continuation) {
        super(2, continuation);
        this.this$0 = aniVortexProvider;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AniVortexProvider$getMainPage$3$ottDef$1$deferredList$9(this.this$0, continuation);
    }
