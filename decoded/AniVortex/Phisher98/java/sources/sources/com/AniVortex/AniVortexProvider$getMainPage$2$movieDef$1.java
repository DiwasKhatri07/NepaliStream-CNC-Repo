...
@DebugMetadata(c = "com.AniVortex.AniVortexProvider$getMainPage$2$movieDef$1", f = "AniVortexProvider.kt", i = {}, l = {62}, m = "invokeSuspend", n = {}, nl = {-1}, s = {}, v = 2)
final class AniVortexProvider$getMainPage$2$movieDef$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends HomePageList>>, Object> {
    int label;
    final /* synthetic */ AniVortexProvider this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AniVortexProvider$getMainPage$2$movieDef$1(AniVortexProvider aniVortexProvider, Continuation<? super AniVortexProvider$getMainPage$2$movieDef$1> continuation) {
        super(2, continuation);
        this.this$0 = aniVortexProvider;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AniVortexProvider$getMainPage$2$movieDef$1(this.this$0, continuation);
    }
