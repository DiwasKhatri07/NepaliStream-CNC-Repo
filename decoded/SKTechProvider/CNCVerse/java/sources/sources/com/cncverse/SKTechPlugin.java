...
public final class SKTechPlugin extends Plugin {
    ...
    public SKTechPlugin() {
        ...
        this.sharedPref = activity != null ? activity.getSharedPreferences("SKTech", 0) : null;
    ...
    public void load(@NotNull Context context) {
        ...
        for (Object element$iv : $this$forEach$iv) {
            ...
            if (Intrinsics.areEqual(type, "custom")) {
                ...
                registerMainAPI(new SKTech(displayTitle, catLink));
            }
        }
        Intrinsics.checkNotNull(context, "null cannot be cast to non-null type androidx.appcompat.app.AppCompatActivity");
        final AppCompatActivity activity = (AppCompatActivity) context;
        setOpenSettings(new Function1() { // from class: com.cncverse.SKTechPlugin$$ExternalSyntheticLambda0
            public final Object invoke(Object obj6) {
                return SKTechPlugin.load$lambda$3(this.f$0, activity, (Context) obj6);
            }
        });
    }
    ...
    public static final Unit load$lambda$3(SKTechPlugin this$0, AppCompatActivity $activity, Context it) {
        ...
        frag.show($activity.getSupportFragmentManager(), "SKTechSettings");
