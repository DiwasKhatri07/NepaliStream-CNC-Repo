...
@DebugMetadata(c = "com.cncverse.LivXowLiveEventsProvider$loadLinks$2$1", f = "LivXowLiveEventsProvider.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, nl = {}, s = {}, v = 2)
final class LivXowLiveEventsProvider$loadLinks$2$1 extends SuspendLambda implements Function2<DrmExtractorLink, Continuation<? super Unit>, Object> {
    ...
    LivXowLiveEventsProvider$loadLinks$2$1(String str, String str2, Map<String, String> map, Continuation<? super LivXowLiveEventsProvider$loadLinks$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> livXowLiveEventsProvider$loadLinks$2$1 = new LivXowLiveEventsProvider$loadLinks$2$1(this.$drmKeyBase64, this.$drmKidBase64, this.$headers, continuation);
        livXowLiveEventsProvider$loadLinks$2$1.L$0 = obj;
        return livXowLiveEventsProvider$loadLinks$2$1;
    }
