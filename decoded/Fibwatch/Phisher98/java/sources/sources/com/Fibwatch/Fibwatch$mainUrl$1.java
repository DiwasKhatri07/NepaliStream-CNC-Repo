...
@DebugMetadata(c = "com.Fibwatch.Fibwatch$mainUrl$1", f = "Fibwatch.kt", i = {}, l = {30}, m = "invokeSuspend", n = {}, nl = {-1}, s = {}, v = 2)
final class Fibwatch$mainUrl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
    int label;

    Fibwatch$mainUrl$1(Continuation<? super Fibwatch$mainUrl$1> continuation) {
        super(2, continuation);
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Fibwatch$mainUrl$1(continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        return (domains == null || (fibwatch = domains.getFibwatch()) == null) ? "https://fibwatch.top" : fibwatch;
    }
}
