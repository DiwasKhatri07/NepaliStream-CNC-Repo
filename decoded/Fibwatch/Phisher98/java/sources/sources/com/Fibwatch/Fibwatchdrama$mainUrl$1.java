...
@DebugMetadata(c = "com.Fibwatch.Fibwatchdrama$mainUrl$1", f = "FibWatchDrama.kt", i = {}, l = {10}, m = "invokeSuspend", n = {}, nl = {-1}, s = {}, v = 2)
final class Fibwatchdrama$mainUrl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
    int label;

    Fibwatchdrama$mainUrl$1(Continuation<? super Fibwatchdrama$mainUrl$1> continuation) {
        super(2, continuation);
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new Fibwatchdrama$mainUrl$1(continuation);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        return (domains == null || (fibdrama = domains.getFibdrama()) == null) ? "https://fibdrama.top" : fibdrama;
    }
}
