...
public final /* data */ class DonationConfig {
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((((((((DonationConfig$$ExternalSyntheticBackport0.m1m(this.enabled) * 31) + this.extensionName.hashCode()) * 31) + this.month.hashCode()) * 31) + this.title.hashCode()) * 31) + this.description.hashCode()) * 31) + this.currency.hashCode()) * 31) + DonationConfig$$ExternalSyntheticBackport1.m2m(this.targetAmount)) * 31) + DonationConfig$$ExternalSyntheticBackport1.m2m(this.currentAmount)) * 31) + this.supportersCount) * 31) + this.apiPercent) * 31) + this.primaryDonateUrl.hashCode()) * 31) + this.primaryButtonText.hashCode()) * 31) + this.secondaryDonateUrl.hashCode()) * 31) + this.secondaryButtonText.hashCode()) * 31) + this.adSupportUrl.hashCode()) * 31) + this.adSupportButtonText.hashCode()) * 31) + this.cooldownHours;
    }
    ...
    /* JADX INFO: compiled from: DonationData.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0006\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0006\u0010\u0006\u001a\u00020\u0005J\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lcom/cncverse/donation/DonationConfig$Companion;", "", "<init>", "()V", "OMG10", "", "decodeOmg10", "dynamicTargetAmount", "", "XonProvider_debug"}, k = 1, mv = {2, 3, 0}, xi = 48)
