...
public final class DonationManager {
    ...
    public final void checkAndShow(@NotNull String providerName) {
        ...
        synchronized (gateLock) {
            ...
            BuildersKt.launch$default(scope, (CoroutineContext) null, (CoroutineStart) null, new C00002(activity, providerName, null), 3, (Object) null);
        }
    }
    ...
    static final class C00002 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C00002(AppCompatActivity appCompatActivity, String str, Continuation<? super C00002> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C00002(this.$activity, this.$providerName, continuation);
        }
    ...
    static final class C00011 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00011(AppCompatActivity appCompatActivity, String str, Continuation<? super C00011> continuation) {
            super(2, continuation);
            this.$activity = appCompatActivity;
            this.$providerName = str;
        }
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C00011(this.$activity, this.$providerName, continuation);
        }
    ...
    public final void showNow(@NotNull String providerName) {
        ...
        BuildersKt.launch$default(scope, (CoroutineContext) null, (CoroutineStart) null, new C00011(activity, providerName, null), 3, (Object) null);
    }
