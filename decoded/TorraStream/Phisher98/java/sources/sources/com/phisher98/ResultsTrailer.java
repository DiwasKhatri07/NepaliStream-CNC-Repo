...
public final /* data */ class ResultsTrailer {
    ...
    @NotNull
    public final ResultsTrailer copy(@Nullable ArrayList<Trailers> results) {
    ...
    public ResultsTrailer(@Nullable ArrayList<Trailers> arrayList) {
