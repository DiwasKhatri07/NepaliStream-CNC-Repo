...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\u001a\u0016\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u0086@¢\u0006\u0002\u0010\u0004¨\u0006\u0005"}, d2 = {"showAniDbCFBypassDialogAndWait", "", "url", "", "(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "AniDb"}, k = 2, mv = {2, 4, 0}, xi = 48)
public final class AniDbKt {
    ...
    static final class C00062 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> c00062 = new C00062(this.$url, continuation);
            c00062.L$0 = obj;
            return c00062;
        }
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (activity2 == null || activity2.isFinishing() || activity2.isDestroyed()) {
                        ...
                        final CloudflareWebViewDialog dialog = new CloudflareWebViewDialog(str, new Function1<Boolean, Unit>() { // from class: com.anidb.AniDbKt$showAniDbCFBypassDialogAndWait$2$1$dialog$1
                            ...
                            public final void invoke(boolean success) {
                                AniDbKt.C00062.invokeSuspend$lambda$0$safeResume(resumed, continuation, success);
                            }
                        }, false, 4, null);
                        continuation.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: com.anidb.AniDbKt$showAniDbCFBypassDialogAndWait$2$1$1
                            public /* bridge */ /* synthetic */ Object invoke(Object p1) {
                                invoke((Throwable) p1);
                                return Unit.INSTANCE;
                            }
                            ...
                            public final void invoke(Throwable it) {
                                ...
                                appCompatActivity.runOnUiThread(new Runnable() { // from class: com.anidb.AniDbKt$showAniDbCFBypassDialogAndWait$2$1$1.1
                        ...
                        dialog.show(activity2.getSupportFragmentManager(), "anidb_cf_bypass_auto");
                    }
    ...
    @Nullable
    public static final Object showAniDbCFBypassDialogAndWait(@NotNull String url, @NotNull Continuation<? super Boolean> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain(), new C00062(url, null), continuation);
    }
}
