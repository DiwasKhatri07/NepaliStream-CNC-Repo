...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\u001a\u0016\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u0086@¢\u0006\u0002\u0010\u0004¨\u0006\u0005"}, d2 = {"showKartoonsCFBypassDialogAndWait", "", "url", "", "(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "Kartoons"}, k = 2, mv = {2, 4, 0}, xi = 48)
public final class KartoonsKt {
    ...
    static final class C00102 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
        ...
        C00102(String str, Continuation<? super C00102> continuation) {
            super(2, continuation);
            this.$url = str;
        }

        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> c00102 = new C00102(this.$url, continuation);
            c00102.L$0 = obj;
            return c00102;
        }
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (activity == null || activity.isFinishing() || activity.isDestroyed()) {
                        if (rawActivity != null) {
                            Toast.makeText(rawActivity, "Kartoons: Cloudflare blocked. Go to Settings → Login.", 1).show();
                        }
                        ...
                        final CloudflareWebViewDialog dialog = new CloudflareWebViewDialog(str, new Function1<Boolean, Unit>() { // from class: com.Kartoons.KartoonsKt$showKartoonsCFBypassDialogAndWait$2$1$dialog$1
                            ...
                            public final void invoke(boolean success) {
                                KartoonsKt.C00102.invokeSuspend$lambda$0$safeResume(resumed, continuation, success);
                            }
                        }, false, 4, null);
                        continuation.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: com.Kartoons.KartoonsKt$showKartoonsCFBypassDialogAndWait$2$1$2
                            public /* bridge */ /* synthetic */ Object invoke(Object p1) {
                                invoke((Throwable) p1);
                                return Unit.INSTANCE;
                            }
                            ...
                            public final void invoke(Throwable it) {
                                ...
                                appCompatActivity.runOnUiThread(new Runnable() { // from class: com.Kartoons.KartoonsKt$showKartoonsCFBypassDialogAndWait$2$1$2.1
                        ...
                        dialog.show(activity2.getSupportFragmentManager(), "kartoons_cf_bypass_auto");
                    }
    ...
    @Nullable
    public static final Object showKartoonsCFBypassDialogAndWait(@NotNull String url, @NotNull Continuation<? super Boolean> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain(), new C00102(url, null), continuation);
    }
}
