    ...
    public Object getUrl(@NotNull String url, @Nullable String referer, @NotNull Function1<? super SubtitleFile, Unit> function1, @NotNull Function1<? super ExtractorLink, Unit> function2, @NotNull Continuation<? super Unit> continuation) {
        ...
        switch (c00352.label) {
            case 0:
                ...
                c00352.L$0 = SpillingKt.nullOutSpilledVariable(url);
                c00352.L$1 = SpillingKt.nullOutSpilledVariable(referer);
                c00352.L$2 = function1;
                c00352.L$3 = function2;
                c00352.label = 1;
                obj = coroutine_suspended;
                z = true;
                obj2 = Requests.get$default(app, url, (Map) null, (String) null, (Map) null, (Map) null, false, 0, (TimeUnit) null, 2000L, (Interceptor) null, false, (ResponseParser) null, c00352, 3838, (Object) null);
                c00352 = c00352;
                if (obj2 == obj) {
                    return obj;
                }
                ...
                if (StringsKt.contains(href, "hubcloud", z)) {
                    c00352.L$0 = SpillingKt.nullOutSpilledVariable(url2);
                    c00352.L$1 = SpillingKt.nullOutSpilledVariable(referer2);
                    c00352.L$2 = SpillingKt.nullOutSpilledVariable(function3);
                    c00352.L$3 = SpillingKt.nullOutSpilledVariable(function4);
                    c00352.L$4 = SpillingKt.nullOutSpilledVariable(href);
                    c00352.label = 3;
                    if (ExtractorApiKt.loadExtractor(href, "HubDrive", function3, function4, c00352) == obj) {
                        return obj;
                    }
                ...
                c00352.L$4 = SpillingKt.nullOutSpilledVariable(href);
                c00352.label = 2;
                $result = hubCloud.getUrl(href, "HubDrive", function3, function4, c00352);
                if ($result == obj) {
                    return obj;
                }
                return $result;
            case 1:
                Function1<? super ExtractorLink, Unit> function5 = (Function1) c00352.L$3;
                function3 = (Function1) c00352.L$2;
                String referer3 = (String) c00352.L$1;
                url2 = (String) c00352.L$0;
                ResultKt.throwOnFailure($result);
                obj = coroutine_suspended;
                referer2 = referer3;
                obj2 = $result;
                ...
                c00352.L$4 = SpillingKt.nullOutSpilledVariable(href);
                c00352.label = 2;
                $result = hubCloud2.getUrl(href, "HubDrive", function3, function4, c00352);
                if ($result == obj) {
                    return obj;
                }
                return $result;
