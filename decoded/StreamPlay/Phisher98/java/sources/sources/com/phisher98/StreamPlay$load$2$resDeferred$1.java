...
final class StreamPlay$load$2$resDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super StreamPlay.MediaDetail>, Object> {
    ...
    StreamPlay$load$2$resDeferred$1(String str, Continuation<? super StreamPlay$load$2$resDeferred$1> continuation) {
        super(2, continuation);
        this.$resUrl = str;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StreamPlay$load$2$resDeferred$1(this.$resUrl, continuation);
    }
    ...
    static final class C00711 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super StreamPlay.MediaDetail>, Object> {
        final /* synthetic */ String $resUrl;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00711(String str, Continuation<? super C00711> continuation) {
            super(2, continuation);
            this.$resUrl = str;
        }

        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C00711(this.$resUrl, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    obj = Requests.get$default(MainActivityKt.getApp(), this.$resUrl, (Map) null, (String) null, (Map) null, (Map) null, false, 0, (TimeUnit) null, 0L, (Interceptor) null, false, (ResponseParser) null, (Continuation) this, 4094, (Object) null);
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                Object obj = TimeoutKt.withTimeoutOrNull-KLykuaI(DurationKt.toDuration(8000, DurationUnit.MILLISECONDS), new C00711(this.$resUrl, null), (Continuation) this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return obj;
