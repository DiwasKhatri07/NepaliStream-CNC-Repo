...
public final class StreamPlayExtractor$invokeVideasy$$inlined$safeAmap$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public static final class C02321 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C02321(Semaphore semaphore, Object obj, Continuation continuation, Integer num, Ref.ObjectRef objectRef, String str, Integer num2, Integer num3, String str2, int i, String str3, Integer num4, Map map, Function1 function1, Function1 function2) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02321(this.$semaphore, this.$item, continuation, this.$season$inlined, this.$workingApi$inlined, this.$encTitle$inlined, this.$year$inlined, this.$tmdbId$inlined, this.$imdbId$inlined, this.$enc$inlined, this.$seed$inlined, this.$episode$inlined, this.$headers$inlined, this.$callback$inlined, this.$subtitleCallback$inlined);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r35) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.phisher98.StreamPlayExtractor$invokeVideasy$$inlined$safeAmap$default$1.C02321.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
