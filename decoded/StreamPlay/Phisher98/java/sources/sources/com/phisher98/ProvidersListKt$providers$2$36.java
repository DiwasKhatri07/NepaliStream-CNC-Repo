...
final class ProvidersListKt$providers$2$36 extends SuspendLambda implements Function6<StreamPlay.LinkData, Function1<? super SubtitleFile, ? extends Unit>, Function1<? super ExtractorLink, ? extends Unit>, String, String, Continuation<? super Unit>, Object> {
    ...
    ProvidersListKt$providers$2$36(Continuation<? super ProvidersListKt$providers$2$36> continuation) {
    ...
    public final Object invoke(StreamPlay.LinkData linkData, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function2, String str, String str2, Continuation<? super Unit> continuation) {
        ProvidersListKt$providers$2$36 providersListKt$providers$2$36 = new ProvidersListKt$providers$2$36(continuation);
        providersListKt$providers$2$36.L$0 = linkData;
        providersListKt$providers$2$36.L$1 = function1;
        providersListKt$providers$2$36.L$2 = function2;
        return providersListKt$providers$2$36.invokeSuspend(Unit.INSTANCE);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (!res.isAnime()) {
                    ...
                    this.label = 1;
                    if (StreamPlayExtractor.INSTANCE.invokeKisskh(res.getTitle(), res.getSeason(), res.getEpisode(), res.getLastSeason(), function1, function2, (Continuation) this) == coroutine_suspended) {
