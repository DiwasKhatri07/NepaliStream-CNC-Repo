...
public final class StreamPlayExtractor$invokeRiveStream$$inlined$safeAmap$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public static final class C02101 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C02101(Semaphore semaphore, Object obj, Continuation continuation, Integer num, Integer num2, String str, Integer num3, Function1 function1, Map map) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02101(this.$semaphore, this.$item, continuation, this.$season$inlined, this.$id$inlined, this.$secretKey$inlined, this.$episode$inlined, this.$callback$inlined, this.$headers$inlined);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r51) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.phisher98.StreamPlayExtractor$invokeRiveStream$$inlined$safeAmap$default$1.C02101.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C02101(semaphore, item$iv$iv, null, this.$season$inlined, this.$id$inlined, this.$secretKey$inlined, this.$episode$inlined, this.$callback$inlined, this.$headers$inlined), 2, (Object) null));
