...
public final class StreamPlayExtractor$invokeAnimepahe$$inlined$safeAmap$default$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public static final class C01421 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C01421(Semaphore semaphore, Object obj, Continuation continuation, boolean z, String str, Function1 function1, Function1 function2) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01421(this.$semaphore, this.$item, continuation, this.$isMovie$inlined, this.$dubtype$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
        }
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C01421(semaphore, item$iv$iv, null, this.$isMovie$inlined, this.$dubtype$inlined, this.$subtitleCallback$inlined, this.$callback$inlined), 2, (Object) null));
