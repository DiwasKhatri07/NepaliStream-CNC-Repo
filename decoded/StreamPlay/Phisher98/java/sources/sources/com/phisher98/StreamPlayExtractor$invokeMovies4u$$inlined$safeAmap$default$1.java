...
public final class StreamPlayExtractor$invokeMovies4u$$inlined$safeAmap$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Object>>, Object> {
    ...
    public static final class C01921 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Object>, Object> {
        final /* synthetic */ Function1 $callback$inlined;
        final /* synthetic */ Integer $episode$inlined;
        final /* synthetic */ String $id$inlined;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C01921(Semaphore semaphore, Object obj, Continuation continuation, String str, Integer num, Function1 function1, Function1 function2, Integer num2) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01921(this.$semaphore, this.$item, continuation, this.$id$inlined, this.$season$inlined, this.$subtitleCallback$inlined, this.$callback$inlined, this.$episode$inlined);
        }
                ...
                switch (this.label) {
                                            ...
                                            if (this.$season$inlined == null) {
                                                ...
                                                try {
                                                    ...
                                                    try {
                                                        ...
                                                        try {
                                                            C0194x5cf40512 c0194x5cf40512 = new C0194x5cf40512(7, iterable, null, this.$subtitleCallback$inlined, this.$callback$inlined);
                                                            this.L$0 = r11;
                                                            this.L$1 = obj2;
                                                            i4 = i2;
                                                            try {
                                                                ...
                                                                this.I$0 = 7;
                                                                this.label = 4;
                                                                objCoroutineScope2 = CoroutineScopeKt.coroutineScope(c0194x5cf40512, this);
                                                ...
                                                try {
                                                    ...
                                                    try {
                                                        C0195x5cf40513 c0195x5cf40513 = new C0195x5cf40513(7, iterable2, null, this.$season$inlined, this.$episode$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                                                        this.L$0 = semaphore3;
                                                        this.L$1 = obj2;
                                                        this.L$2 = SpillingKt.nullOutSpilledVariable(continuation);
                                                        this.L$3 = SpillingKt.nullOutSpilledVariable(element);
                                                        ...
                                                        this.I$0 = 7;
                                                        this.label = 5;
                                                        objCoroutineScope = CoroutineScopeKt.coroutineScope(c0195x5cf40513, this);
                    ...
                    case 1:
                        ...
                        if (this.$season$inlined == null) {
                            ...
                            C0195x5cf40513 c0195x5cf40514 = new C0195x5cf40513(7, iterable3, null, this.$season$inlined, this.$episode$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                            this.L$0 = semaphore3;
                            this.L$1 = obj2;
                            this.L$2 = SpillingKt.nullOutSpilledVariable(continuation);
                            this.L$3 = SpillingKt.nullOutSpilledVariable(element);
                            ...
                            this.I$0 = 7;
                            this.label = 5;
                            objCoroutineScope = CoroutineScopeKt.coroutineScope(c0195x5cf40514, this);
                            if (objCoroutineScope == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            continuation2 = continuation;
                        ...
                        C0194x5cf40512 c0194x5cf40513 = new C0194x5cf40512(7, iterable4, null, this.$subtitleCallback$inlined, this.$callback$inlined);
                        this.L$0 = r11;
                        this.L$1 = obj2;
                        i4 = i2;
                        this.L$2 = SpillingKt.nullOutSpilledVariable(continuation3);
                        ...
                        this.I$0 = 7;
                        this.label = 4;
                        objCoroutineScope2 = CoroutineScopeKt.coroutineScope(c0194x5cf40513, this);
                        if (objCoroutineScope2 == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        r20 = r11;
                    ...
                    case 2:
                        ...
                        try {
                            ...
                            if (this.$season$inlined == null) {
                                ...
                                C0195x5cf40513 c0195x5cf40515 = new C0195x5cf40513(7, iterable5, null, this.$season$inlined, this.$episode$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                                this.L$0 = semaphore3;
                                this.L$1 = obj2;
                                this.L$2 = SpillingKt.nullOutSpilledVariable(continuation);
                                this.L$3 = SpillingKt.nullOutSpilledVariable(element);
                                ...
                                this.I$0 = 7;
                                this.label = 5;
                                objCoroutineScope = CoroutineScopeKt.coroutineScope(c0195x5cf40515, this);
                                if (objCoroutineScope == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                continuation2 = continuation;
                            ...
                            C0194x5cf40512 c0194x5cf40514 = new C0194x5cf40512(7, iterable6, null, this.$subtitleCallback$inlined, this.$callback$inlined);
                            this.L$0 = r11;
                            this.L$1 = obj2;
                            i4 = i2;
                            this.L$2 = SpillingKt.nullOutSpilledVariable(continuation3);
                            ...
                            this.I$0 = 7;
                            this.label = 4;
                            objCoroutineScope2 = CoroutineScopeKt.coroutineScope(c0194x5cf40514, this);
                            if (objCoroutineScope2 == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            r20 = r11;
                    ...
                    case 3:
                        ...
                        try {
                            try {
                                ...
                                C0194x5cf40512 c0194x5cf40515 = new C0194x5cf40512(7, iterable7, null, this.$subtitleCallback$inlined, this.$callback$inlined);
                                this.L$0 = r11;
                                this.L$1 = obj2;
                                i4 = i2;
                                this.L$2 = SpillingKt.nullOutSpilledVariable(continuation3);
                                ...
                                this.I$0 = 7;
                                this.label = 4;
                                objCoroutineScope2 = CoroutineScopeKt.coroutineScope(c0194x5cf40515, this);
                                if (objCoroutineScope2 == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                r20 = r11;
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C01921(semaphore, item$iv$iv, null, this.$id$inlined, this.$season$inlined, this.$subtitleCallback$inlined, this.$callback$inlined, this.$episode$inlined), 2, (Object) null));
