...
public final class StreamPlayExtractor$invokeTopMovies$$inlined$safeAmap$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Object>>, Object> {
    ...
    public static final class C02201 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Object>, Object> {
        final /* synthetic */ Function1 $callback$inlined;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C02201(Semaphore semaphore, Object obj, Continuation continuation, String str, Function1 function1, Function1 function2) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02201(this.$semaphore, this.$item, continuation, this.$topmoviesAPI$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
        }
                ...
                switch (this.label) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        if (detailPageDocument == null) {
                                            ...
                                            try {
                                                ...
                                                try {
                                                    C0223x5ff82339 c0223x5ff82339 = new C0223x5ff82339(7, $this$safeAmap_u24default$iv, null, this.$topmoviesAPI$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                                                    ...
                                                    this.I$0 = 7;
                                                    this.label = 3;
                                                    objCoroutineScope = CoroutineScopeKt.coroutineScope(c0223x5ff82339, this);
                                    ...
                                    if (detailPageDocument == null) {
                                        ...
                                        C0223x5ff82339 c0223x5ff823310 = new C0223x5ff82339(7, $this$safeAmap_u24default$iv2, null, this.$topmoviesAPI$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                                        this.L$0 = $this$withPermit$iv6;
                                        this.L$1 = obj5;
                                        this.L$2 = SpillingKt.nullOutSpilledVariable($completion3);
                                        this.L$3 = SpillingKt.nullOutSpilledVariable(detailPageUrl3);
                                        ...
                                        this.I$0 = 7;
                                        this.label = 3;
                                        objCoroutineScope = CoroutineScopeKt.coroutineScope(c0223x5ff823310, this);
                                        if (objCoroutineScope == coroutine_suspended) {
                                            return coroutine_suspended;
                                        }
                                        $i$f$withPermit5 = $i$f$withPermit4;
                    ...
                    case 1:
                        ...
                        if (detailPageDocument == null) {
                            ...
                            C0223x5ff82339 c0223x5ff823311 = new C0223x5ff82339(7, $this$safeAmap_u24default$iv3, null, this.$topmoviesAPI$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                            this.L$0 = $this$withPermit$iv6;
                            this.L$1 = obj5;
                            this.L$2 = SpillingKt.nullOutSpilledVariable($completion3);
                            this.L$3 = SpillingKt.nullOutSpilledVariable(detailPageUrl3);
                            ...
                            this.I$0 = 7;
                            this.label = 3;
                            objCoroutineScope = CoroutineScopeKt.coroutineScope(c0223x5ff823311, this);
                            if (objCoroutineScope == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            $i$f$withPermit5 = $i$f$withPermit4;
                    ...
                    case 2:
                        ...
                        try {
                            ...
                            if (detailPageDocument == null) {
                                ...
                                C0223x5ff82339 c0223x5ff823312 = new C0223x5ff82339(7, $this$safeAmap_u24default$iv4, null, this.$topmoviesAPI$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                                this.L$0 = $this$withPermit$iv6;
                                this.L$1 = obj5;
                                this.L$2 = SpillingKt.nullOutSpilledVariable($completion3);
                                this.L$3 = SpillingKt.nullOutSpilledVariable(detailPageUrl3);
                                ...
                                this.I$0 = 7;
                                this.label = 3;
                                objCoroutineScope = CoroutineScopeKt.coroutineScope(c0223x5ff823312, this);
                                if (objCoroutineScope == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                $i$f$withPermit5 = $i$f$withPermit4;
                        ...
                        if (detailPageDocument == null) {
                            ...
                            C0223x5ff82339 c0223x5ff823313 = new C0223x5ff82339(7, $this$safeAmap_u24default$iv5, null, this.$topmoviesAPI$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                            this.L$0 = $this$withPermit$iv6;
                            this.L$1 = obj5;
                            this.L$2 = SpillingKt.nullOutSpilledVariable($completion3);
                            this.L$3 = SpillingKt.nullOutSpilledVariable(detailPageUrl3);
                            ...
                            this.I$0 = 7;
                            this.label = 3;
                            objCoroutineScope = CoroutineScopeKt.coroutineScope(c0223x5ff823313, this);
                            if (objCoroutineScope == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            $i$f$withPermit5 = $i$f$withPermit4;
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C02201(semaphore, item$iv$iv, null, this.$topmoviesAPI$inlined, this.$subtitleCallback$inlined, this.$callback$inlined), 2, (Object) null));
