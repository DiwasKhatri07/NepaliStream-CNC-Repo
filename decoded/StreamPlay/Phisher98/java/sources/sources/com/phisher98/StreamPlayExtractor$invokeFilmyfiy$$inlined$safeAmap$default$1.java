...
public final class StreamPlayExtractor$invokeFilmyfiy$$inlined$safeAmap$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Result<? extends List<? extends Result<? extends List<? extends Boolean>>>>>>, Object> {
    ...
    public static final class C01521 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends List<? extends Result<? extends List<? extends Boolean>>>>>, Object> {
        final /* synthetic */ String $baseUrl$inlined;
        final /* synthetic */ Function1 $callback$inlined;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C01521(Semaphore semaphore, Object obj, Continuation continuation, String str, Function1 function1, Function1 function2) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01521(this.$semaphore, this.$item, continuation, this.$baseUrl$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
        }
            ...
            try {
                switch (this.label) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        C0154x95d66476 c0154x95d66476 = new C0154x95d66476(7, $this$safeAmap_u24default$iv, null, this.$baseUrl$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                                        ...
                                        this.I$0 = 7;
                                        this.label = 3;
                                        objCoroutineScope = CoroutineScopeKt.coroutineScope(c0154x95d66476, this);
                    ...
                    case 1:
                        ...
                        C0154x95d66476 c0154x95d66477 = new C0154x95d66476(7, $this$safeAmap_u24default$iv2, null, this.$baseUrl$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                        this.L$0 = $this$withPermit$iv4;
                        this.L$1 = obj3;
                        this.L$2 = SpillingKt.nullOutSpilledVariable($completion2);
                        this.L$3 = SpillingKt.nullOutSpilledVariable(postUrl2);
                        ...
                        this.I$0 = 7;
                        this.label = 3;
                        objCoroutineScope = CoroutineScopeKt.coroutineScope(c0154x95d66477, this);
                        if (objCoroutineScope == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        obj4 = Result.constructor-impl((List) objCoroutineScope);
                    ...
                    case 2:
                        ...
                        try {
                            ...
                            C0154x95d66476 c0154x95d66478 = new C0154x95d66476(7, $this$safeAmap_u24default$iv3, null, this.$baseUrl$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                            this.L$0 = $this$withPermit$iv4;
                            this.L$1 = obj3;
                            this.L$2 = SpillingKt.nullOutSpilledVariable($completion2);
                            this.L$3 = SpillingKt.nullOutSpilledVariable(postUrl2);
                            ...
                            this.I$0 = 7;
                            this.label = 3;
                            objCoroutineScope = CoroutineScopeKt.coroutineScope(c0154x95d66478, this);
                            if (objCoroutineScope == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            obj4 = Result.constructor-impl((List) objCoroutineScope);
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C01521(semaphore, item$iv$iv, null, this.$baseUrl$inlined, this.$subtitleCallback$inlined, this.$callback$inlined), 2, (Object) null));
