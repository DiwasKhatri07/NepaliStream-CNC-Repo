...
public final class StreamPlayExtractor$invokeMapple$$inlined$safeAmap$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public static final class C01871 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C01871(Semaphore semaphore, Object obj, Continuation continuation, String str, Integer num, String str2, String str3, String str4, String str5, Map map, Function1 function1, Ref.BooleanRef booleanRef) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01871(this.$semaphore, this.$item, continuation, this.$base$inlined, this.$tmdbId$inlined, this.$mediaType$inlined, this.$tvSlug$inlined, this.$requestToken$inlined, this.$finalToken$inlined, this.$headers$inlined, this.$callback$inlined, this.$foundStreams$inlined);
        }
            ...
            try {
                switch (c01871.label) {
                    case 0:
                        ...
                        Semaphore $this$withPermit$iv4 = c01871.$semaphore;
                        obj = c01871.$item;
                        c01871.L$0 = $this$withPermit$iv4;
                        c01871.L$1 = obj;
                        c01871.label = 1;
                        if ($this$withPermit$iv4.acquire((Continuation) c01871) == coroutine_suspended) {
                        ...
                        try {
                            try {
                                ...
                                try {
                                    streamUrl = c01871.$base$inlined + "/api/stream?mediaId=" + c01871.$tmdbId$inlined.intValue() + "&mediaType=" + c01871.$mediaType$inlined + "&tv_slug=" + c01871.$tvSlug$inlined + "&source=" + sourceId + "&apikey=mptv_sk_a8f29c4e7b3d1f&requestToken=" + c01871.$requestToken$inlined + "&token=" + c01871.$finalToken$inlined;
                                    Requests app = MainActivityKt.getApp();
                                    Map map = c01871.$headers$inlined;
                                    c01871.L$0 = $this$withPermit$iv2;
                                    c01871.L$1 = obj;
                                    c01871.L$2 = SpillingKt.nullOutSpilledVariable($completion);
                                    c01871.L$3 = SpillingKt.nullOutSpilledVariable(sourceId);
                                    c01871.L$4 = sourceName;
                                    c01871.L$5 = SpillingKt.nullOutSpilledVariable(streamUrl);
                                    c01871.label = 2;
                                    obj3 = obj;
                                                ...
                                                try {
                                                    ...
                                                    if (zAreEqual) {
                                                        ...
                                                        if (z2) {
                                                            ...
                                                            String str2 = c01871.$base$inlined + '/';
                                                            Map map2 = c01871.$headers$inlined;
                                                            c01871.L$0 = $this$withPermit$iv;
                                                            c01871.L$1 = obj2;
                                                            c01871.L$2 = SpillingKt.nullOutSpilledVariable($completion);
                                                            c01871.L$3 = SpillingKt.nullOutSpilledVariable(sourceId4);
                                                            c01871.L$4 = SpillingKt.nullOutSpilledVariable(sourceName2);
                                                            c01871.L$5 = SpillingKt.nullOutSpilledVariable(sourceId5);
                                                            c01871.L$6 = SpillingKt.nullOutSpilledVariable(m3u9);
                                                            c01871.L$7 = SpillingKt.nullOutSpilledVariable(streamRes);
                                                            c01871.label = 3;
                                                            objGenerateM3u8$default = M3u8Helper.Companion.generateM3u8$default(companion, string, m3u9, str2, (Integer) null, map2, (String) null, c01871, 40, (Object) null);
                                                            ...
                                                            try {
                                                                ...
                                                                for (Object element$iv : $this$forEach$iv) {
                                                                    ...
                                                                    try {
                                                                        c01871.$callback$inlined.invoke(it);
                                                                        c01871.$foundStreams$inlined.element = true;
                    ...
                    case 1:
                        obj = c01871.L$1;
                        $this$withPermit$iv2 = (Semaphore) c01871.L$0;
                        ResultKt.throwOnFailure($result);
                        $i$f$withPermit = 0;
                        i = 0;
                        Pair pair2 = (Pair) obj;
                        ...
                        Map map3 = c01871.$headers$inlined;
                        c01871.L$0 = $this$withPermit$iv2;
                        c01871.L$1 = obj;
                        c01871.L$2 = SpillingKt.nullOutSpilledVariable($completion);
                        c01871.L$3 = SpillingKt.nullOutSpilledVariable(sourceId);
                        ...
                        if (zAreEqual) {
                            ...
                            if (z2) {
                                ...
                                String str3 = c01871.$base$inlined + '/';
                                Map map4 = c01871.$headers$inlined;
                                c01871.L$0 = $this$withPermit$iv;
                                c01871.L$1 = obj2;
                                c01871.L$2 = SpillingKt.nullOutSpilledVariable($completion);
                                c01871.L$3 = SpillingKt.nullOutSpilledVariable(sourceId4);
                                ...
                                c01871.L$7 = SpillingKt.nullOutSpilledVariable(streamRes);
                                c01871.label = 3;
                                objGenerateM3u8$default = M3u8Helper.Companion.generateM3u8$default(companion2, string2, m3u9, str3, (Integer) null, map4, (String) null, c01871, 40, (Object) null);
                                if (objGenerateM3u8$default == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                sourceId2 = sourceName2;
                                ...
                                while (r4.hasNext()) {
                                    ...
                                    c01871.$callback$inlined.invoke(it2);
                                    c01871.$foundStreams$inlined.element = true;
                        ...
                        return unit;
                    case 2:
                        String streamUrl2 = (String) c01871.L$5;
                        sourceId2 = (String) c01871.L$4;
                        sourceId3 = (String) c01871.L$3;
                        ...
                        try {
                            ...
                            if (zAreEqual) {
                                ...
                                if (z2) {
                                    ...
                                    String str4 = c01871.$base$inlined + '/';
                                    Map map5 = c01871.$headers$inlined;
                                    c01871.L$0 = $this$withPermit$iv;
                                    c01871.L$1 = obj2;
                                    c01871.L$2 = SpillingKt.nullOutSpilledVariable($completion);
                                    c01871.L$3 = SpillingKt.nullOutSpilledVariable(sourceId4);
                                    ...
                                    c01871.L$7 = SpillingKt.nullOutSpilledVariable(streamRes);
                                    c01871.label = 3;
                                    objGenerateM3u8$default = M3u8Helper.Companion.generateM3u8$default(companion3, string3, m3u9, str4, (Integer) null, map5, (String) null, c01871, 40, (Object) null);
                                    if (objGenerateM3u8$default == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                                    sourceId2 = sourceName2;
                                    ...
                                    while (r4.hasNext()) {
                                        ...
                                        c01871.$callback$inlined.invoke(it3);
                                        c01871.$foundStreams$inlined.element = true;
                    ...
                    case 3:
                        ...
                        try {
                            ...
                            while (r4.hasNext()) {
                                ...
                                c01871.$callback$inlined.invoke(it4);
                                c01871.$foundStreams$inlined.element = true;
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C01871(semaphore, item$iv$iv, null, this.$base$inlined, this.$tmdbId$inlined, this.$mediaType$inlined, this.$tvSlug$inlined, this.$requestToken$inlined, this.$finalToken$inlined, this.$headers$inlined, this.$callback$inlined, this.$foundStreams$inlined), 2, (Object) null));
