...
public final class C0123xd854210f extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Resource<? extends Unit>>>, Object> {
    ...
    public C0123xd854210f(int i, Iterable iterable, Continuation continuation, String str, Function1 function1, Function1 function2, Map map) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> c0123xd854210f = new C0123xd854210f(this.$concurrency, this.$this_runCatching, continuation, this.$lang$inlined, this.$subtitleCallback$inlined, this.$callback$inlined, this.$headers$inlined);
        c0123xd854210f.L$0 = obj;
        return c0123xd854210f;
    }
