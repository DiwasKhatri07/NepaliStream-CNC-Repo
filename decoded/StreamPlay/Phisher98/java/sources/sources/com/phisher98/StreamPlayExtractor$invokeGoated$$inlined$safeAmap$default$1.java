...
public final class StreamPlayExtractor$invokeGoated$$inlined$safeAmap$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public static final class C01641 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C01641(Semaphore semaphore, Object obj, Continuation continuation, byte[] bArr, String str, String str2, String str3, Function1 function1, boolean z, Integer num, Integer num2, Integer num3) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01641(this.$semaphore, this.$item, continuation, this.$actualKey$inlined, this.$sessionJwt$inlined, this.$sessionIp$inlined, this.$refererPath$inlined, this.$callback$inlined, this.$isTv$inlined, this.$tmdbId$inlined, this.$season$inlined, this.$episode$inlined);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r39) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.phisher98.StreamPlayExtractor$invokeGoated$$inlined$safeAmap$default$1.C01641.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C01641(semaphore, item$iv$iv, null, this.$actualKey$inlined, this.$sessionJwt$inlined, this.$sessionIp$inlined, this.$refererPath$inlined, this.$callback$inlined, this.$isTv$inlined, this.$tmdbId$inlined, this.$season$inlined, this.$episode$inlined), 2, (Object) null));
