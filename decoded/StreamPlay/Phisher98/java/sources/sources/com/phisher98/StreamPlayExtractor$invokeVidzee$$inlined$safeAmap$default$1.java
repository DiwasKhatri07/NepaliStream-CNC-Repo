...
public final class StreamPlayExtractor$invokeVidzee$$inlined$safeAmap$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public static final class C02361 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C02361(Semaphore semaphore, Object obj, Continuation continuation, Integer num, Integer num2, Integer num3, byte[] bArr, String str, Function1 function1, Function1 function2) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02361(this.$semaphore, this.$item, continuation, this.$season$inlined, this.$id$inlined, this.$episode$inlined, this.$keyBytes$inlined, this.$defaultReferer$inlined, this.$callback$inlined, this.$subtitleCallback$inlined);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r42) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.phisher98.StreamPlayExtractor$invokeVidzee$$inlined$safeAmap$default$1.C02361.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C02361(semaphore, item$iv$iv, null, this.$season$inlined, this.$id$inlined, this.$episode$inlined, this.$keyBytes$inlined, this.$defaultReferer$inlined, this.$callback$inlined, this.$subtitleCallback$inlined), 2, (Object) null));
