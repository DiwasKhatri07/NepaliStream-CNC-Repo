...
public final class C0128x74a3699c extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Result<? extends Unit>>>, Object> {
    ...
    public C0128x74a3699c(int i, Iterable iterable, Continuation continuation, StreamPlayExtractor streamPlayExtractor, String str, Map map, Function1 function1) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> c0128x74a3699c = new C0128x74a3699c(this.$concurrency, this.$this_runCatching, continuation, this.$this_runCatching$inlined, this.$host$inlined, this.$headers$inlined, this.$callback$inlined);
        c0128x74a3699c.L$0 = obj;
        return c0128x74a3699c;
    }
