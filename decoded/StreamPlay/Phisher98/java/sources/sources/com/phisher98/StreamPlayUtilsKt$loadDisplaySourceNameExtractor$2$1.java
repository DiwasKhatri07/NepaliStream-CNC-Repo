...
final class StreamPlayUtilsKt$loadDisplaySourceNameExtractor$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.L$0 = function2;
                this.label = 1;
                objNewExtractorLink$default = ExtractorApiKt.newExtractorLink$default(str2, str4, this.$link.getUrl(), (ExtractorLinkType) null, new C02981(this.$quality, this.$link, null), (Continuation) this, 8, (Object) null);
    ...
    static final class C02981 extends SuspendLambda implements Function2<ExtractorLink, Continuation<? super Unit>, Object> {
        final /* synthetic */ ExtractorLink $link;
        final /* synthetic */ Integer $quality;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02981(Integer num, ExtractorLink extractorLink, Continuation<? super C02981> continuation) {
            super(2, continuation);
            this.$quality = num;
            this.$link = extractorLink;
        }
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> c02981 = new C02981(this.$quality, this.$link, continuation);
            c02981.L$0 = obj;
            return c02981;
        }
