...
public final /* data */ class MetaAnimeData {
    ...
    @NotNull
    public final MetaAnimeData copy(@JsonProperty("titles") @Nullable Map<String, String> titles, @JsonProperty("images") @Nullable List<ImageData> images, @JsonProperty("episodes") @Nullable Map<String, MetaEpisode> episodes, @JsonProperty("mappings") @Nullable MetaMappings mappings) {
    ...
    public MetaAnimeData(@JsonProperty("titles") @Nullable Map<String, String> map, @JsonProperty("images") @Nullable List<ImageData> list, @JsonProperty("episodes") @Nullable Map<String, MetaEpisode> map2, @JsonProperty("mappings") @Nullable MetaMappings mappings) {
        this.titles = map;
        this.images = list;
        this.episodes = map2;
    ...
    public /* synthetic */ MetaAnimeData(Map map, List list, Map map2, MetaMappings metaMappings, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : map, (i & 2) != 0 ? null : list, (i & 4) != 0 ? null : map2, (i & 8) != 0 ? null : metaMappings);
    }
