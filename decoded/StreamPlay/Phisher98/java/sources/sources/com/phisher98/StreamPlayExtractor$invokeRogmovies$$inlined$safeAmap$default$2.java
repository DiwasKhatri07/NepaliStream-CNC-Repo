...
public final class StreamPlayExtractor$invokeRogmovies$$inlined$safeAmap$default$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public static final class C02151 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C02151(Semaphore semaphore, Object obj, Continuation continuation, Map map, String str, String str2, Function1 function1, Function1 function2) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02151(this.$semaphore, this.$item, continuation, this.$headers$inlined, this.$api$inlined, this.$episodeText$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r31) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.phisher98.StreamPlayExtractor$invokeRogmovies$$inlined$safeAmap$default$2.C02151.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C02151(semaphore, item$iv$iv, null, this.$headers$inlined, this.$api$inlined, this.$episodeText$inlined, this.$subtitleCallback$inlined, this.$callback$inlined), 2, (Object) null));
