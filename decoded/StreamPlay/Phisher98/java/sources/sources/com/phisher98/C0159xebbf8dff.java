...
public final class C0159xebbf8dff extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public C0159xebbf8dff(int i, Iterable iterable, Continuation continuation, Function1 function1, Function1 function2, Integer num) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> c0159xebbf8dff = new C0159xebbf8dff(this.$concurrency, this.$this_runCatching, continuation, this.$subtitleCallback$inlined, this.$callback$inlined, this.$episode$inlined);
        c0159xebbf8dff.L$0 = obj;
        return c0159xebbf8dff;
    }
