...
public final class StreamPlayExtractor$invokeTopMovies$$inlined$safeAmap$default$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public static final class C02211 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C02211(Semaphore semaphore, Object obj, Continuation continuation, String str, Function1 function1, Function1 function2, Integer num) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02211(this.$semaphore, this.$item, continuation, this.$topmoviesAPI$inlined, this.$subtitleCallback$inlined, this.$callback$inlined, this.$episode$inlined);
        }
                ...
                try {
                    switch (c02211.label) {
                        case 0:
                            ...
                            Semaphore semaphore7 = c02211.$semaphore;
                            Object obj9 = c02211.$item;
                            c02211.L$0 = semaphore7;
                            c02211.L$1 = obj9;
                            c02211.label = 1;
                            if (semaphore7.acquire((Continuation) c02211) == coroutine_suspended) {
                            ...
                            i2 = 0;
                            try {
                                continuation = (Continuation) c02211;
                                str = (String) obj4;
                                StreamPlayExtractor streamPlayExtractor = StreamPlayExtractor.INSTANCE;
                                try {
                                    Result.Companion companion = Result.Companion;
                                    c02211.L$0 = semaphore2;
                                    c02211.L$1 = obj4;
                                    c02211.L$2 = SpillingKt.nullOutSpilledVariable(continuation);
                                    c02211.L$3 = SpillingKt.nullOutSpilledVariable(str);
                                    c02211.L$4 = SpillingKt.nullOutSpilledVariable(streamPlayExtractor);
                                    c02211.label = 2;
                                            ...
                                            if (document == null) {
                                                ...
                                                while (true) {
                                                    if (it.hasNext()) {
                                                        ...
                                                        try {
                                                            try {
                                                                regex = new Regex(".*Episode\\s+" + c02211.$episode$inlined + ".*", RegexOption.IGNORE_CASE);
                                                        ...
                                                        if (element == null && (elementParent = element.parent()) != null && (elementClosest = elementParent.closest("a")) != null && (strAttr = elementClosest.attr("href")) != null) {
                                                            ...
                                                            if (strAttr != null) {
                                                                ...
                                                                if (StringsKt.contains$default(str3, "unblockedgames", false, 2, (Object) null)) {
                                                                    c02211.L$0 = semaphore;
                                                                    c02211.L$1 = obj2;
                                                                    c02211.L$2 = SpillingKt.nullOutSpilledVariable(continuation2);
                                                                    c02211.L$3 = SpillingKt.nullOutSpilledVariable(str2);
                                                                    c02211.L$4 = SpillingKt.nullOutSpilledVariable(str3);
                                                                    c02211.L$5 = SpillingKt.nullOutSpilledVariable(document2);
                                                                    c02211.label = 3;
                                                                    objBypassHrefli = StreamPlayUtilsKt.bypassHrefli(str3, c02211);
                                                                ...
                                                                try {
                                                                    String str8 = c02211.$topmoviesAPI$inlined + '/';
                                                                    Function1 function1 = c02211.$subtitleCallback$inlined;
                                                                    Function1 function2 = c02211.$callback$inlined;
                                                                    c02211.L$0 = semaphore5;
                                                                    c02211.L$1 = obj7;
                                                                    c02211.L$2 = SpillingKt.nullOutSpilledVariable(continuation3);
                                                                    c02211.L$3 = SpillingKt.nullOutSpilledVariable(str6);
                                                                    c02211.L$4 = SpillingKt.nullOutSpilledVariable(str4);
                                                                    c02211.L$5 = SpillingKt.nullOutSpilledVariable(str5);
                                                                    c02211.L$6 = SpillingKt.nullOutSpilledVariable(document2);
                                                                    c02211.label = 4;
                                                                    semaphore6 = semaphore5;
                                                                    Object obj10 = obj7;
                                                                    try {
                                                                        objLoadSourceNameExtractor$default = StreamPlayUtilsKt.loadSourceNameExtractor$default("TopMovies", str4, str8, function1, function2, null, null, c02211, 96, null);
                            ...
                            break;
                        case 1:
                            Object obj11 = c02211.L$1;
                            Semaphore semaphore11 = (Semaphore) c02211.L$0;
                            ResultKt.throwOnFailure(obj);
                            i = 0;
                            obj4 = obj11;
                            ...
                            c02211.L$2 = SpillingKt.nullOutSpilledVariable(continuation);
                            c02211.L$3 = SpillingKt.nullOutSpilledVariable(str);
                            c02211.L$4 = SpillingKt.nullOutSpilledVariable(streamPlayExtractor2);
                            c02211.label = 2;
                            semaphore3 = semaphore2;
                            objSafeGet$default = StreamPlayUtilsKt.safeGet$default(str, null, null, null, null, false, 0, this, 126, null);
                            c02211 = this;
                        ...
                        case 2:
                            ...
                            i4 = 0;
                            i5 = 0;
                            str2 = (String) c02211.L$3;
                            continuation2 = (Continuation) c02211.L$2;
                            obj5 = c02211.L$1;
                            semaphore4 = (Semaphore) c02211.L$0;
                            try {
                                ResultKt.throwOnFailure(obj);
                                i2 = 0;
                        ...
                        case 3:
                            i9 = 0;
                            i4 = 0;
                            Document document3 = (Document) c02211.L$5;
                            str3 = (String) c02211.L$4;
                            str2 = (String) c02211.L$3;
                            continuation2 = (Continuation) c02211.L$2;
                            obj2 = c02211.L$1;
                            semaphore = (Semaphore) c02211.L$0;
                            ResultKt.throwOnFailure(obj);
                            document2 = document3;
                            regex = null;
                            i5 = 0;
                            ...
                            if (str7 == null) {
                                ...
                                obj7 = obj2;
                                regex = regex;
                                String str9 = c02211.$topmoviesAPI$inlined + '/';
                                Function1 function3 = c02211.$subtitleCallback$inlined;
                                Function1 function4 = c02211.$callback$inlined;
                                c02211.L$0 = semaphore5;
                                c02211.L$1 = obj7;
                                c02211.L$2 = SpillingKt.nullOutSpilledVariable(continuation3);
                                c02211.L$3 = SpillingKt.nullOutSpilledVariable(str6);
                                ...
                                semaphore6 = semaphore5;
                                Object obj12 = obj7;
                                objLoadSourceNameExtractor$default = StreamPlayUtilsKt.loadSourceNameExtractor$default("TopMovies", str4, str9, function3, function4, null, null, c02211, 96, null);
                                if (objLoadSourceNameExtractor$default == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                obj8 = objLoadSourceNameExtractor$default;
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C02211(semaphore, item$iv$iv, null, this.$topmoviesAPI$inlined, this.$subtitleCallback$inlined, this.$callback$inlined, this.$episode$inlined), 2, (Object) null));
