...
@DebugMetadata(c = "com.phisher98.ProvidersListKt$providers$2$9", f = "ProvidersList.kt", i = {0, 0, 0, 1, 1, 1, 1}, l = {170, 171}, m = "invokeSuspend", n = {"res", "subtitleCallback", "callback", "res", "subtitleCallback", "callback", "ids"}, nl = {171, 173}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3"}, v = 2)
final class ProvidersListKt$providers$2$9 extends SuspendLambda implements Function6<StreamPlay.LinkData, Function1<? super SubtitleFile, ? extends Unit>, Function1<? super ExtractorLink, ? extends Unit>, String, String, Continuation<? super Unit>, Object> {
    ...
    ProvidersListKt$providers$2$9(Continuation<? super ProvidersListKt$providers$2$9> continuation) {
    ...
    public final Object invoke(StreamPlay.LinkData linkData, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function2, String str, String str2, Continuation<? super Unit> continuation) {
        ProvidersListKt$providers$2$9 providersListKt$providers$2$9 = new ProvidersListKt$providers$2$9(continuation);
        providersListKt$providers$2$9.L$0 = linkData;
        providersListKt$providers$2$9.L$1 = function1;
        providersListKt$providers$2$9.L$2 = function2;
        return providersListKt$providers$2$9.invokeSuspend(Unit.INSTANCE);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (res.isAnime()) {
                    ...
                    this.label = 2;
                    if (streamPlayExtractor.invokeAnikage(anilistId, title, res.getEpisode(), function1, function2, ProvidersListKt.getDubStatus(res), (Continuation) this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
