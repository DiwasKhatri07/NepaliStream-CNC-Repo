...
public final class C0193x5cf40513 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public C0193x5cf40513(int i, Iterable iterable, Continuation continuation, Integer num, Integer num2, Function1 function1, Function1 function2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> c0193x5cf40513 = new C0193x5cf40513(this.$concurrency, this.$this_runCatching, continuation, this.$season$inlined, this.$episode$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
        c0193x5cf40513.L$0 = obj;
        return c0193x5cf40513;
    }
                                                ...
                                                if (this.$episode$inlined != null) {
                                                    ...
                                                    if (z) {
                                                        ...
                                                        try {
                                                            ...
                                                            try {
                                                                C0194xc07bce5f c0194xc07bce5f = new C0194xc07bce5f(7, $this$safeAmap_u24default$iv, null, this.$subtitleCallback$inlined, this.$callback$inlined);
                                                                ...
                                                                try {
                                                                    ...
                                                                    this.I$0 = 7;
                                                                    this.label = 3;
                                                                    objCoroutineScope = CoroutineScopeKt.coroutineScope(c0194xc07bce5f, this);
                        ...
                        try {
                            ...
                            if (this.$episode$inlined != null) {
                                ...
                                if (z) {
                                    ...
                                    C0194xc07bce5f c0194xc07bce5f2 = new C0194xc07bce5f(7, $this$safeAmap_u24default$iv2, null, this.$subtitleCallback$inlined, this.$callback$inlined);
                                    this.L$0 = $this$withPermit$iv2;
                                    this.L$1 = obj;
                                    i3 = i;
                                    this.L$2 = SpillingKt.nullOutSpilledVariable($completion);
                                    ...
                                    this.I$0 = 7;
                                    this.label = 3;
                                    objCoroutineScope = CoroutineScopeKt.coroutineScope(c0194xc07bce5f2, this);
                                    if (objCoroutineScope == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                                    $this$withPermit$iv3 = $this$withPermit$iv2;
