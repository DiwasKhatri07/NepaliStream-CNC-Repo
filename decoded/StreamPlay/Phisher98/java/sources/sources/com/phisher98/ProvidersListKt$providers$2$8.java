...
@DebugMetadata(c = "com.phisher98.ProvidersListKt$providers$2$8", f = "ProvidersList.kt", i = {0, 0, 0, 1, 1, 1, 1}, l = {164, 165}, m = "invokeSuspend", n = {"res", "subtitleCallback", "callback", "res", "subtitleCallback", "callback", "ids"}, nl = {165, 167}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3"}, v = 2)
final class ProvidersListKt$providers$2$8 extends SuspendLambda implements Function6<StreamPlay.LinkData, Function1<? super SubtitleFile, ? extends Unit>, Function1<? super ExtractorLink, ? extends Unit>, String, String, Continuation<? super Unit>, Object> {
    ...
    ProvidersListKt$providers$2$8(Continuation<? super ProvidersListKt$providers$2$8> continuation) {
    ...
    public final Object invoke(StreamPlay.LinkData linkData, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function2, String str, String str2, Continuation<? super Unit> continuation) {
        ProvidersListKt$providers$2$8 providersListKt$providers$2$8 = new ProvidersListKt$providers$2$8(continuation);
        providersListKt$providers$2$8.L$0 = linkData;
        providersListKt$providers$2$8.L$1 = function1;
        providersListKt$providers$2$8.L$2 = function2;
        return providersListKt$providers$2$8.invokeSuspend(Unit.INSTANCE);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (res.isAnime()) {
                    ...
                    this.label = 2;
                    if (StreamPlayExtractor.INSTANCE.invokeAnichi(res.getJpTitle(), res.getTitle(), ids.getTmdbYear(), res.getEpisode(), function1, function2, ProvidersListKt.getDubStatus(res), (Continuation) this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
