...
@Metadata(d1 = {"\u0000x\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001:\u000201B)\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0010\b\u0002\u0010\u0006\u001a\n\u0012\u0004\u0012\u00020\b\u0018\u00010\u0007¢\u0006\u0004\b\t\u0010\nJ\b\u0010\u000b\u001a\u00020\bH\u0016J\u0010\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\rH\u0002J#\u0010\u0013\u001a\u0002H\u0014\"\b\b\u0000\u0010\u0014*\u00020\u0015*\u00020\u00152\u0006\u0010\u0012\u001a\u00020\rH\u0002¢\u0006\u0002\u0010\u0016J\u001e\u0010\u0017\u001a\u00020\b*\u00020\u0015H\u0003b\u0010\b\u0018\u0012\f\b\u0019\u0012\b\b\fJ\u0004\b\b(\u001aJ\"\u0010\u001b\u001a\u00020\u00152\u0006\u0010\u0012\u001a\u00020\r2\u0006\u0010\u001c\u001a\u00020\u001d2\b\u0010\u001e\u001a\u0004\u0018\u00010\u001fH\u0002J6\u0010 \u001a\u00020\u00152\u0006\u0010\u001c\u001a\u00020\u001d2\b\u0010\u001e\u001a\u0004\u0018\u00010\u001f2\b\u0010!\u001a\u0004\u0018\u00010\"H\u0017b\u0010\b\u0018\u0012\f\b\u0019\u0012\b\b\fJ\u0004\b\b(#J\u001a\u0010$\u001a\u00020\b2\u0006\u0010%\u001a\u00020\u00152\b\u0010!\u001a\u0004\u0018\u00010\"H\u0016J\b\u0010&\u001a\u00020\bH\u0002J\u000e\u0010'\u001a\b\u0012\u0004\u0012\u00020)0(H\u0002J\u0016\u0010*\u001a\u00020\b2\f\u0010+\u001a\b\u0012\u0004\u0012\u00020)0,H\u0002J\u0010\u0010-\u001a\u00020\b2\u0006\u0010.\u001a\u00020/H\u0016R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u0006\u001a\n\u0012\u0004\u0012\u00020\b\u0018\u00010\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX\u0082D¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u000fX\u0082\u0004¢\u0006\u0002\n\u0000¨\u00062"}, d2 = {"Lcom/phisher98/StreamPlayStremioAddonFrag;", "Landroidx/fragment/app/DialogFragment;", "plugin", "Lcom/phisher98/StreamPlayPlugin;", "sharedPref", "Landroid/content/SharedPreferences;", "onDismissCallback", "Lkotlin/Function0;", "", "<init>", "(Lcom/phisher98/StreamPlayPlugin;Landroid/content/SharedPreferences;Lkotlin/jvm/functions/Function0;)V", "onStart", "PREF_KEY_LINKS", "", "res", "Landroid/content/res/Resources;", "getDrawable", "Landroid/graphics/drawable/Drawable;", "name", "findView", "T", "Landroid/view/View;", "(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;", "makeTvCompatible", "Landroid/annotation/SuppressLint;", "value", "UseCompatLoadingForDrawables", "getLayout", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "onCreateView", "savedInstanceState", "Landroid/os/Bundle;", "DiscouragedApi", "onViewCreated", "view", "restartApp", "loadLinks", "", "Lcom/phisher98/StreamPlayStremioAddonFrag$LinkItem;", "saveLinks", "list", "", "onDismiss", "dialog", "Landroid/content/DialogInterface;", "LinkItem", "LinksAdapter", "StreamPlay"}, k = 1, mv = {2, 4, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nStreamPlayStremioAddonFrag.kt\nKotlin\n*S Kotlin\n*F\n+ 1 StreamPlayStremioAddonFrag.kt\ncom/phisher98/StreamPlayStremioAddonFrag\n+ 2 SharedPreferences.kt\nandroidx/core/content/SharedPreferencesKt\n+ 3 Uri.kt\nandroidx/core/net/UriKt\n+ 4 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 5 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,324:1\n40#2,11:325\n29#3:336\n1#4:337\n2077#5,3:338\n*S KotlinDebug\n*F\n+ 1 StreamPlayStremioAddonFrag.kt\ncom/phisher98/StreamPlayStremioAddonFrag\n*L\n279#1:325,11\n144#1:336\n114#1:338,3\n*E\n"})
public final class StreamPlayStremioAddonFrag extends DialogFragment {
    ...
    public StreamPlayStremioAddonFrag(@NotNull StreamPlayPlugin plugin, @NotNull SharedPreferences sharedPref, @Nullable Function0<Unit> function0) throws Exception {
        this.sharedPref = sharedPref;
        this.onDismissCallback = function0;
        this.PREF_KEY_LINKS = StreamPlayStremioAddonSettings.PREF_KEY_LINKS;
    ...
    public /* synthetic */ StreamPlayStremioAddonFrag(StreamPlayPlugin streamPlayPlugin, SharedPreferences sharedPreferences, Function0 function0, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public View onCreateView(@NotNull final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = getLayout("streamplay_stremio_addon_bottom_sheet_layout", inflater, container);
        ...
        addlinks.setOnClickListener(new View.OnClickListener() { // from class: com.phisher98.StreamPlayStremioAddonFrag$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                StreamPlayStremioAddonFrag.onCreateView$lambda$0(this.f$0, inflater, container, view2);
            }
        });
        showlinks.setOnClickListener(new View.OnClickListener() { // from class: com.phisher98.StreamPlayStremioAddonFrag$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) throws Exception {
                StreamPlayStremioAddonFrag.onCreateView$lambda$1(this.f$0, inflater, container, view2);
            }
        });
        saveIcon.setOnClickListener(new View.OnClickListener() { // from class: com.phisher98.StreamPlayStremioAddonFrag$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                StreamPlayStremioAddonFrag.onCreateView$lambda$2(this.f$0, view2);
            }
        });
        return view;
    }

    static final void onCreateView$lambda$0(final StreamPlayStremioAddonFrag this$0, LayoutInflater $inflater, ViewGroup $container, View it) {
        View dialogView = this$0.getLayout("streamio_addon_addlinks", $inflater, $container);
        try {
            EditText etName = (EditText) this$0.findView(dialogView, "etName");
            try {
                ...
                rg.removeAllViews();
                Iterable $this$forEachIndexed$iv = CollectionsKt.listOf(new StreamPlayStremioAddonType[]{StreamPlayStremioAddonType.HTTPS, StreamPlayStremioAddonType.TORRENT, StreamPlayStremioAddonType.SUBTITLE, StreamPlayStremioAddonType.DEBRID});
                int index = 0;
                for (Object item$iv : $this$forEachIndexed$iv) {
                    ...
                    StreamPlayStremioAddonType type = (StreamPlayStremioAddonType) item$iv;
                    RadioButton $this$onCreateView_u24lambda_u240_u240_u240 = new RadioButton(this$0.requireContext());
                    EditText etName2 = etName;
                    $this$onCreateView_u24lambda_u240_u240_u240.setId(View.generateViewId());
                    $this$onCreateView_u24lambda_u240_u240_u240.setText(type.name());
                    $this$onCreateView_u24lambda_u240_u240_u240.setTag(type.name());
                    $this$onCreateView_u24lambda_u240_u240_u240.setChecked(index == 0);
                    rg.addView($this$onCreateView_u24lambda_u240_u240_u240);
                    index = index$iv;
                    etName = etName2;
                }
                final EditText etName3 = etName;
                ...
                dlg.setOnShowListener(new DialogInterface.OnShowListener() { // from class: com.phisher98.StreamPlayStremioAddonFrag$$ExternalSyntheticLambda7
                    @Override // android.content.DialogInterface.OnShowListener
                    public final void onShow(DialogInterface dialogInterface) {
                        StreamPlayStremioAddonFrag.onCreateView$lambda$0$1(dlg, etName3, etLink, rg, this$0, dialogInterface);
                    }
                });
                dlg.show();
            } catch (Throwable th) {
                ...
                Log.INSTANCE.e("StreamPlayStremioAddonFrag", "Missing dialog views " + t);
            }
        } catch (Throwable th2) {
            t = th2;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void onCreateView$lambda$0$1(final AlertDialog $dlg, final EditText $etName, final EditText $etLink, final RadioGroup $rg, final StreamPlayStremioAddonFrag this$0, DialogInterface it) {
        $dlg.getButton(-1).setOnClickListener(new View.OnClickListener() { // from class: com.phisher98.StreamPlayStremioAddonFrag$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                StreamPlayStremioAddonFrag.onCreateView$lambda$0$1$0($etName, $etLink, $rg, this$0, $dlg, view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onCreateView$lambda$0$1$0(EditText $etName, EditText $etLink, RadioGroup $rg, StreamPlayStremioAddonFrag this$0, AlertDialog $dlg, View it) {
        String scheme;
        Object tag;
        String string;
        ...
        String type = (radioButton == null || (tag = radioButton.getTag()) == null || (string = tag.toString()) == null) ? "HTTPS" : string;
        boolean z = true;
        if (link.length() == 0) {
        ...
        try {
            ...
            String $this$toUri$iv = uri.getScheme();
            if ($this$toUri$iv != null) {
                scheme = $this$toUri$iv.toLowerCase(Locale.ROOT);
                Intrinsics.checkNotNullExpressionValue(scheme, "toLowerCase(...)");
            } else {
                scheme = null;
            }
            if (!Intrinsics.areEqual(scheme, "http") && !Intrinsics.areEqual(scheme, "https") && !Intrinsics.areEqual(scheme, "stremio")) {
                z = false;
            }
        } catch (Exception e) {
            z = false;
        ...
        boolean valid = z;
        if (!valid) {
            CommonActivity.showToast$default(CommonActivity.INSTANCE, "Enter a valid URL (http/https/stremio)", (Integer) null, 2, (Object) null);
            return;
        }
        try {
            ...
            mutableList.add(0, new LinkItem(0L, str, link, type, 1, null));
            try {
                ...
                e = th;
                Log.INSTANCE.e("StreamPlayStremioAddonFrag", "Failed to save link " + e);
    ...
    static final void onCreateView$lambda$1(final StreamPlayStremioAddonFrag this$0, LayoutInflater $inflater, ViewGroup $container, View it) throws Exception {
        ...
        if (list.isEmpty()) {
            ...
            rv.setAdapter(this$0.new LinksAdapter(list, new Function1() { // from class: com.phisher98.StreamPlayStremioAddonFrag$$ExternalSyntheticLambda4
                public final Object invoke(Object obj) {
                    return StreamPlayStremioAddonFrag.onCreateView$lambda$1$0(this.f$0, rv, tvNoLinks, (StreamPlayStremioAddonFrag.LinkItem) obj);
                }
            }));
        }
        dlg.show();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onCreateView$lambda$1$0(StreamPlayStremioAddonFrag this$0, RecyclerView $rv, TextView $tvNoLinks, final LinkItem itemToDelete) throws JSONException {
        List<LinkItem> mutableList = CollectionsKt.toMutableList(this$0.loadLinks());
        boolean removed = CollectionsKt.removeAll(mutableList, new Function1() { // from class: com.phisher98.StreamPlayStremioAddonFrag$$ExternalSyntheticLambda6
            public final Object invoke(Object obj) {
                return Boolean.valueOf(StreamPlayStremioAddonFrag.onCreateView$lambda$1$0$0(itemToDelete, (StreamPlayStremioAddonFrag.LinkItem) obj));
            }
        });
        if (removed) {
            this$0.saveLinks(mutableList);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean onCreateView$lambda$1$0$0(LinkItem $itemToDelete, LinkItem it) {
        return it.getId() == $itemToDelete.getId();
    }

    static final void onCreateView$lambda$2(final StreamPlayStremioAddonFrag this$0, View it) {
        Context context = this$0.getContext();
        if (context == null) {
            return;
        }
        new AlertDialog.Builder(context).setTitle("Save & Reload").setMessage("Changes have been saved. Do you want to restart the app to apply them?").setPositiveButton("Yes", new DialogInterface.OnClickListener() { // from class: com.phisher98.StreamPlayStremioAddonFrag$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                StreamPlayStremioAddonFrag.onCreateView$lambda$2$0(this.f$0, dialogInterface, i);
            }
        }).setNegativeButton("No", (DialogInterface.OnClickListener) null).show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onCreateView$lambda$2$0(StreamPlayStremioAddonFrag this$0, DialogInterface dialogInterface, int i) {
        this$0.dismiss();
        this$0.restartApp();
    }
    ...
    /* JADX INFO: compiled from: StreamPlayStremioAddonFrag.kt */
    @Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0010\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\b\u0018\u00002\u00020\u0001B)\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0005\u0012\u0006\u0010\u0007\u001a\u00020\u0005¢\u0006\u0004\b\b\u0010\tJ\t\u0010\u0010\u001a\u00020\u0003HÆ\u0003J\t\u0010\u0011\u001a\u00020\u0005HÆ\u0003J\t\u0010\u0012\u001a\u00020\u0005HÆ\u0003J\t\u0010\u0013\u001a\u00020\u0005HÆ\u0003J1\u0010\u0014\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u00052\b\b\u0002\u0010\u0007\u001a\u00020\u0005HÆ\u0001J\u0014\u0010\u0015\u001a\u00020\u00162\b\u0010\u0017\u001a\u0004\u0018\u00010\u0001HÖ\u0083\u0004J\n\u0010\u0018\u001a\u00020\u0019HÖ\u0081\u0004J\n\u0010\u001a\u001a\u00020\u0005HÖ\u0081\u0004R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u0011\u0010\u0006\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\rR\u0011\u0010\u0007\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\r¨\u0006\u001b"}, d2 = {"Lcom/phisher98/StreamPlayStremioAddonFrag$LinkItem;", "", "id", "", "name", "", "link", "type", "<init>", "(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "getId", "()J", "getName", "()Ljava/lang/String;", "getLink", "getType", "component1", "component2", "component3", "component4", "copy", "equals", "", "other", "hashCode", "", "toString", "StreamPlay"}, k = 1, mv = {2, 4, 0}, xi = 48)
    public static final /* data */ class LinkItem {
        ...
        public int hashCode() {
            return (((((StreamPlayStremioAddonFrag$LinkItem$$ExternalSyntheticBackport0.m30m(this.id) * 31) + this.name.hashCode()) * 31) + this.link.hashCode()) * 31) + this.type.hashCode();
        }
    ...
    private final List<LinkItem> loadLinks() {
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                ...
                list.add(new LinkItem(obj.optLong("id", System.currentTimeMillis()), obj.optString("name", ""), obj.optString("link", ""), obj.optString("type", "HTTPS")));
            }
            return list;
        } catch (Exception e) {
            return new ArrayList();
    ...
    public final class LinksAdapter extends RecyclerView.Adapter<C0264VH> {
        ...
        public final class C0264VH extends RecyclerView.ViewHolder {
            ...
            public C0264VH(View v) {
                ...
                this.tvType = (TextView) StreamPlayStremioAddonFrag.this.findView(v, "tvType");
                this.btnDelete = (ImageButton) StreamPlayStremioAddonFrag.this.findView(v, "btnDelete");
            }
        ...
        @NotNull
        public C0264VH onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
            ...
            return new C0264VH(v);
        }

        public void onBindViewHolder(@NotNull C0264VH holder, int position) {
            ...
            holder.getBtnDelete().setOnClickListener(new View.OnClickListener() { // from class: com.phisher98.StreamPlayStremioAddonFrag$LinksAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
