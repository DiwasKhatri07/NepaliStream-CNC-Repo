...
public final class StreamPlayStremioAddonFrag extends DialogFragment {
    ...
    public final class LinksAdapter extends RecyclerView.Adapter<C0262VH> {
        ...
        public final class C0262VH extends RecyclerView.ViewHolder {
        ...
        @NotNull
        public C0262VH onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
            ...
            return new C0262VH(v);
        }

        public void onBindViewHolder(@NotNull C0262VH holder, int position) {
