...
final class StreamPlayConcurrency$runLimitedAsync$2$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    StreamPlayConcurrency$runLimitedAsync$2$1$1(Semaphore semaphore, Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super StreamPlayConcurrency$runLimitedAsync$2$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StreamPlayConcurrency$runLimitedAsync$2$1$1(this.$semaphore, this.$task, continuation);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                try {
                    ...
                    $this$withPermit$iv3 = $this$withPermit$iv;
                    e = e2;
                    Log.INSTANCE.e("StreamPlayConcurrency", "Task failed: " + e.getMessage());
                } catch (Throwable th2) {
                    th = th2;
                    $this$withPermit$iv3 = $this$withPermit$iv;
                    $this$withPermit$iv3.release();
