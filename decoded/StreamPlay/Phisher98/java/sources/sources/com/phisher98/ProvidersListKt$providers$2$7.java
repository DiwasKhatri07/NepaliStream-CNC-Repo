...
@DebugMetadata(c = "com.phisher98.ProvidersListKt$providers$2$7", f = "ProvidersList.kt", i = {0, 0, 0, 1, 1, 1, 1, 1}, l = {158, 159}, m = "invokeSuspend", n = {"res", "subtitleCallback", "callback", "res", "subtitleCallback", "callback", "ids", "it"}, nl = {159, 159}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3", "L$4"}, v = 2)
@SourceDebugExtension({"SMAP\nProvidersList.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ProvidersList.kt\ncom/phisher98/ProvidersListKt$providers$2$7\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,353:1\n1#2:354\n*E\n"})
final class ProvidersListKt$providers$2$7 extends SuspendLambda implements Function6<StreamPlay.LinkData, Function1<? super SubtitleFile, ? extends Unit>, Function1<? super ExtractorLink, ? extends Unit>, String, String, Continuation<? super Unit>, Object> {
    ...
    ProvidersListKt$providers$2$7(Continuation<? super ProvidersListKt$providers$2$7> continuation) {
    ...
    public final Object invoke(StreamPlay.LinkData linkData, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function2, String str, String str2, Continuation<? super Unit> continuation) {
        ProvidersListKt$providers$2$7 providersListKt$providers$2$7 = new ProvidersListKt$providers$2$7(continuation);
        providersListKt$providers$2$7.L$0 = linkData;
        providersListKt$providers$2$7.L$1 = function1;
        providersListKt$providers$2$7.L$2 = function2;
        return providersListKt$providers$2$7.invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Code duplicated, block: B:15:0x0056  */
    /* JADX WARN: Code duplicated, block: B:17:0x0089 A[RETURN] */
            ...
            case 0:
                ...
                if (res.isAnime()) {
                    ...
                    if (it != null) {
                        ...
                        this.label = 2;
                        if (streamPlayExtractor.invokeAnimepahe(it, episode, function1, function2, dubStatus, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                }
