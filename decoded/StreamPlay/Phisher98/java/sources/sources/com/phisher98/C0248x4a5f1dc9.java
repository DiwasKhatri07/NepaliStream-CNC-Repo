...
public final class C0248x4a5f1dc9 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Unit>>, Object> {
    ...
    public C0248x4a5f1dc9(int i, Iterable iterable, Continuation continuation, Function1 function1, Function1 function2, Integer num) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> c0248x4a5f1dc9 = new C0248x4a5f1dc9(this.$concurrency, this.$this_runCatching, continuation, this.$subtitleCallback$inlined, this.$callback$inlined, this.$episode$inlined);
        c0248x4a5f1dc9.L$0 = obj;
        return c0248x4a5f1dc9;
    }
