...
final class C0064x17c6b087 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
    final /* synthetic */ String $proxy;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    C0064x17c6b087(String str, Continuation<? super C0064x17c6b087> continuation) {
        super(2, continuation);
        this.$proxy = str;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C0064x17c6b087(this.$proxy, continuation);
    }
