...
public final class StreamPlayStremioCatelogFrag extends DialogFragment {
    ...
    public static final /* data */ class LinkItem {
        ...
        public int hashCode() {
            return (((((C0280x37150983.m31m(this.id) * 31) + this.name.hashCode()) * 31) + this.link.hashCode()) * 31) + this.type.hashCode();
        }
    ...
    public final class LinksAdapter extends RecyclerView.Adapter<C0282VH> {
        ...
        public final class C0282VH extends RecyclerView.ViewHolder {
        ...
        @NotNull
        public C0282VH onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
            ...
            return new C0282VH(v);
        }

        public void onBindViewHolder(@NotNull C0282VH holder, int position) {
