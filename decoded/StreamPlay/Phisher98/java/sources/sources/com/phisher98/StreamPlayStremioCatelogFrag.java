...
public final class StreamPlayStremioCatelogFrag extends DialogFragment {
    ...
    public static final /* data */ class LinkItem {
        ...
        public int hashCode() {
            return (((((C0278x37150983.m31m(this.id) * 31) + this.name.hashCode()) * 31) + this.link.hashCode()) * 31) + this.type.hashCode();
        }
    ...
    public final class LinksAdapter extends RecyclerView.Adapter<C0280VH> {
        ...
        public final class C0280VH extends RecyclerView.ViewHolder {
        ...
        @NotNull
        public C0280VH onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
            ...
            return new C0280VH(v);
        }

        public void onBindViewHolder(@NotNull C0280VH holder, int position) {
