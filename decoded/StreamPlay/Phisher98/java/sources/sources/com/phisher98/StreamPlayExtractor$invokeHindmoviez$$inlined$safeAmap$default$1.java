...
public final class StreamPlayExtractor$invokeHindmoviez$$inlined$safeAmap$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Result<? extends List<? extends Unit>>>>, Object> {
    ...
    public static final class C01741 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends List<? extends Unit>>>, Object> {
        final /* synthetic */ Function1 $callback$inlined;
        final /* synthetic */ Integer $episode$inlined;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C01741(Semaphore semaphore, Object obj, Continuation continuation, Integer num, Function1 function1, Function1 function2, Integer num2) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01741(this.$semaphore, this.$item, continuation, this.$episode$inlined, this.$subtitleCallback$inlined, this.$callback$inlined, this.$season$inlined);
        }
                ...
                switch (this.label) {
                            ...
                            try {
                                ...
                                if (this.$episode$inlined == null) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            C0176x3343ef76 c0176x3343ef76 = new C0176x3343ef76(7, $this$safeAmap_u24default$iv, null, this.$subtitleCallback$inlined, this.$callback$inlined);
                                            ...
                                            try {
                                                ...
                                                this.I$0 = 7;
                                                this.label = 3;
                                                objCoroutineScope2 = CoroutineScopeKt.coroutineScope(c0176x3343ef76, this);
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                C0177x3343ef77 c0177x3343ef77 = new C0177x3343ef77(7, $this$safeAmap_u24default$iv2, null, this.$season$inlined, this.$episode$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                                                this.L$0 = $this$withPermit$iv5;
                                                this.L$1 = obj4;
                                                this.L$2 = SpillingKt.nullOutSpilledVariable($completion2);
                                                this.L$3 = SpillingKt.nullOutSpilledVariable(entry2);
                                                ...
                                                this.I$0 = 7;
                                                this.label = 4;
                                                objCoroutineScope = CoroutineScopeKt.coroutineScope(c0177x3343ef77, this);
                    ...
                    case 1:
                        ...
                        if (this.$episode$inlined == null) {
                            ...
                            C0176x3343ef76 c0176x3343ef77 = new C0176x3343ef76(7, $this$safeAmap_u24default$iv3, null, this.$subtitleCallback$inlined, this.$callback$inlined);
                            this.L$0 = $this$withPermit$iv5;
                            this.L$1 = obj4;
                            this.L$2 = SpillingKt.nullOutSpilledVariable($completion2);
                            this.L$3 = SpillingKt.nullOutSpilledVariable(entry2);
                            ...
                            this.I$0 = 7;
                            this.label = 3;
                            objCoroutineScope2 = CoroutineScopeKt.coroutineScope(c0176x3343ef77, this);
                            if (objCoroutineScope2 == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            obj5 = Result.constructor-impl((List) objCoroutineScope2);
                        ...
                        C0177x3343ef77 c0177x3343ef78 = new C0177x3343ef77(7, $this$safeAmap_u24default$iv4, null, this.$season$inlined, this.$episode$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                        this.L$0 = $this$withPermit$iv5;
                        this.L$1 = obj4;
                        this.L$2 = SpillingKt.nullOutSpilledVariable($completion2);
                        this.L$3 = SpillingKt.nullOutSpilledVariable(entry2);
                        ...
                        this.I$0 = 7;
                        this.label = 4;
                        objCoroutineScope = CoroutineScopeKt.coroutineScope(c0177x3343ef78, this);
                        if (objCoroutineScope == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        obj5 = Result.constructor-impl((List) objCoroutineScope);
                        ...
                        try {
                            try {
                                ...
                                if (this.$episode$inlined == null) {
                                    ...
                                    C0176x3343ef76 c0176x3343ef78 = new C0176x3343ef76(7, $this$safeAmap_u24default$iv5, null, this.$subtitleCallback$inlined, this.$callback$inlined);
                                    this.L$0 = $this$withPermit$iv5;
                                    this.L$1 = obj4;
                                    this.L$2 = SpillingKt.nullOutSpilledVariable($completion2);
                                    this.L$3 = SpillingKt.nullOutSpilledVariable(entry2);
                                    ...
                                    this.I$0 = 7;
                                    this.label = 3;
                                    objCoroutineScope2 = CoroutineScopeKt.coroutineScope(c0176x3343ef78, this);
                                    if (objCoroutineScope2 == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                                    obj5 = Result.constructor-impl((List) objCoroutineScope2);
                                ...
                                C0177x3343ef77 c0177x3343ef79 = new C0177x3343ef77(7, $this$safeAmap_u24default$iv6, null, this.$season$inlined, this.$episode$inlined, this.$subtitleCallback$inlined, this.$callback$inlined);
                                this.L$0 = $this$withPermit$iv5;
                                this.L$1 = obj4;
                                this.L$2 = SpillingKt.nullOutSpilledVariable($completion2);
                                this.L$3 = SpillingKt.nullOutSpilledVariable(entry2);
                                ...
                                this.I$0 = 7;
                                this.label = 4;
                                objCoroutineScope = CoroutineScopeKt.coroutineScope(c0177x3343ef79, this);
                                if (objCoroutineScope == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                                obj5 = Result.constructor-impl((List) objCoroutineScope);
        ...
        switch (this.label) {
            case 0:
                ...
                for (Object item$iv$iv : $this$map$iv) {
                    ...
                    destination$iv$iv2.add(BuildersKt.async$default($this$coroutineScope, Dispatchers.getIO(), (CoroutineStart) null, new C01741(semaphore, item$iv$iv, null, this.$episode$inlined, this.$subtitleCallback$inlined, this.$callback$inlined, this.$season$inlined), 2, (Object) null));
