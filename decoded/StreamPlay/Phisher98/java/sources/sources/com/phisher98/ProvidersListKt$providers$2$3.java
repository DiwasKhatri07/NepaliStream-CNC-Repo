...
@DebugMetadata(c = "com.phisher98.ProvidersListKt$providers$2$3", f = "ProvidersList.kt", i = {0, 0, 0, 1, 1, 1, 1, 1}, l = {133, 134}, m = "invokeSuspend", n = {"res", "subtitleCallback", "callback", "res", "subtitleCallback", "callback", "ids", "it"}, nl = {134, 135}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3", "I$0"}, v = 2)
@SourceDebugExtension({"SMAP\nProvidersList.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ProvidersList.kt\ncom/phisher98/ProvidersListKt$providers$2$3\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,353:1\n1#2:354\n*E\n"})
final class ProvidersListKt$providers$2$3 extends SuspendLambda implements Function6<StreamPlay.LinkData, Function1<? super SubtitleFile, ? extends Unit>, Function1<? super ExtractorLink, ? extends Unit>, String, String, Continuation<? super Unit>, Object> {
    int I$0;
    ...
    ProvidersListKt$providers$2$3(Continuation<? super ProvidersListKt$providers$2$3> continuation) {
    ...
    public final Object invoke(StreamPlay.LinkData linkData, Function1<? super SubtitleFile, Unit> function1, Function1<? super ExtractorLink, Unit> function2, String str, String str2, Continuation<? super Unit> continuation) {
        ProvidersListKt$providers$2$3 providersListKt$providers$2$3 = new ProvidersListKt$providers$2$3(continuation);
        providersListKt$providers$2$3.L$0 = linkData;
        providersListKt$providers$2$3.L$1 = function1;
        providersListKt$providers$2$3.L$2 = function2;
        return providersListKt$providers$2$3.invokeSuspend(Unit.INSTANCE);
    }
            ...
            case 0:
                ...
                if (res.isAnime()) {
                    ...
                    if (malId != null) {
                        ...
                        this.I$0 = it;
                        this.label = 2;
                        if (streamPlayExtractor.invokeAnimetosho(function1, function2, dubStatus, numBoxInt, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                }
