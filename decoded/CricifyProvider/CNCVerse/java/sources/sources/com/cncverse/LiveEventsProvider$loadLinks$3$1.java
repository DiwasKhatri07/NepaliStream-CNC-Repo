...
@DebugMetadata(c = "com.cncverse.LiveEventsProvider$loadLinks$3$1", f = "LiveEventsProvider.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, nl = {}, s = {}, v = 2)
final class LiveEventsProvider$loadLinks$3$1 extends SuspendLambda implements Function2<DrmExtractorLink, Continuation<? super Unit>, Object> {
    ...
    LiveEventsProvider$loadLinks$3$1(String str, String str2, Map<String, String> map, Continuation<? super LiveEventsProvider$loadLinks$3$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> liveEventsProvider$loadLinks$3$1 = new LiveEventsProvider$loadLinks$3$1(this.$drmKeyBase64, this.$drmKidBase64, this.$headers, continuation);
        liveEventsProvider$loadLinks$3$1.L$0 = obj;
        return liveEventsProvider$loadLinks$3$1;
    }
