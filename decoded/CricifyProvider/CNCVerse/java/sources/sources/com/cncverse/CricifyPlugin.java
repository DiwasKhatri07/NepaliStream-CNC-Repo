...
public final class CricifyPlugin extends Plugin {
    ...
    public void load(@NotNull Context context) {
        ...
        this.iptvProviders = (List) BuildersKt.runBlocking$default((CoroutineContext) null, new C00121(null), 1, (Object) null);
        ...
        for (Object element$iv : $this$forEach$iv) {
            ...
            if (Intrinsics.areEqual(type, "custom")) {
                registerMainAPI(new LiveEventsProvider(displayTitle, catLink));
            } else {
                registerMainAPI(new Cricify(displayTitle, catLink));
            }
        }
        ...
        setOpenSettings(new Function1() { // from class: com.cncverse.CricifyPlugin$$ExternalSyntheticLambda0
            public final Object invoke(Object obj6) {
                return CricifyPlugin.load$lambda$3(this.f$0, activity, (Context) obj6);
            }
        });
    }

    /* JADX INFO: renamed from: com.cncverse.CricifyPlugin$load$1 */
    /* JADX INFO: compiled from: CricifyPlugin.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010 \n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0010\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00040\u00020\u0001*\u00020\u0005H\n"}, d2 = {"<anonymous>", "", "", "", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 3, 0}, xi = 48)
    @DebugMetadata(c = "com.cncverse.CricifyPlugin$load$1", f = "CricifyPlugin.kt", i = {}, l = {27}, m = "invokeSuspend", n = {}, nl = {-1}, s = {}, v = 2)
    static final class C00121 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends Map<String, ? extends Object>>>, Object> {
        int label;
