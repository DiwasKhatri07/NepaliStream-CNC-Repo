...
public final class DonationManager {
    ...
    public final void checkAndShow(@NotNull String providerName) {
        ...
        synchronized (gateLock) {
            ...
            BuildersKt.launch$default(scope, (CoroutineContext) null, (CoroutineStart) null, new C00092(activity, providerName, null), 3, (Object) null);
        }
    }
    ...
    static final class C00092 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C00092(AppCompatActivity appCompatActivity, String str, Continuation<? super C00092> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C00092(this.$activity, this.$providerName, continuation);
        }
    ...
    public final void showNow(@NotNull String providerName) {
        ...
        BuildersKt.launch$default(scope, (CoroutineContext) null, (CoroutineStart) null, new C00101(activity, providerName, null), 3, (Object) null);
    }
