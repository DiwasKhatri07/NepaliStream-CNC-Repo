...
/* JADX INFO: compiled from: SportzxSettings.kt */
...
@Metadata(d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010!\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B'\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007¢\u0006\u0004\b\t\u0010\nJ\f\u0010\r\u001a\u00020\u000e*\u00020\u000fH\u0002J\u0012\u0010\u0010\u001a\u0004\u0018\u00010\u00112\u0006\u0010\u0012\u001a\u00020\bH\u0003J\u0012\u0010\u0013\u001a\u0004\u0018\u00010\b2\u0006\u0010\u0012\u001a\u00020\bH\u0003J%\u0010\u0014\u001a\u0004\u0018\u0001H\u0015\"\b\b\u0000\u0010\u0015*\u00020\u000f*\u00020\u000f2\u0006\u0010\u0012\u001a\u00020\bH\u0003¢\u0006\u0002\u0010\u0016J&\u0010\u0017\u001a\u0004\u0018\u00010\u000f2\u0006\u0010\u0018\u001a\u00020\u00192\b\u0010\u001a\u001a\u0004\u0018\u00010\u001b2\b\u0010\u001c\u001a\u0004\u0018\u00010\u001dH\u0017J\u001a\u0010\u001e\u001a\u00020\u000e2\u0006\u0010\u001f\u001a\u00020\u000f2\b\u0010\u001c\u001a\u0004\u0018\u00010\u001dH\u0017J\b\u0010 \u001a\u00020\u000eH\u0002J\u0010\u0010!\u001a\u00020\"2\u0006\u0010#\u001a\u00020\bH\u0002R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0004\u001a\u0004\u0018\u00010\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\b0\fX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006$"}, d2 = {"Lcom/cncverse/SportzxSettings;", "Lcom/google/android/material/bottomsheet/BottomSheetDialogFragment;", "plugin", "Lcom/cncverse/SportzxPlugin;", "sharedPref", "Landroid/content/SharedPreferences;", "playlistNames", "", "", "<init>", "(Lcom/cncverse/SportzxPlugin;Landroid/content/SharedPreferences;Ljava/util/List;)V", "enabledPlaylists", "", "makeTvCompatible", "", "Landroid/view/View;", "getDrawable", "Landroid/graphics/drawable/Drawable;", "name", "getString", "findViewByName", "T", "(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;", "onCreateView", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "onViewCreated", "view", "restartApp", "getPlaylistRow", "Landroid/widget/RelativeLayout;", "playlistName", "SportzxProvider_debug"}, k = 1, mv = {2, 3, 0}, xi = 48)
@SourceDebugExtension({"SMAP\nSportzxSettings.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SportzxSettings.kt\ncom/cncverse/SportzxSettings\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,177:1\n777#2:178\n873#2,2:179\n1915#2,2:182\n1915#2,2:184\n1#3:181\n*S KotlinDebug\n*F\n+ 1 SportzxSettings.kt\ncom/cncverse/SportzxSettings\n*L\n33#1:178\n33#1:179,2\n94#1:182,2\n101#1:184,2\n*E\n"})
public final class SportzxSettings extends BottomSheetDialogFragment {
    ...
    @NotNull
    private final SportzxPlugin plugin;

    @Nullable
    private final SharedPreferences sharedPref;

    public SportzxSettings(@NotNull SportzxPlugin plugin, @Nullable SharedPreferences sharedPref, @NotNull List<String> list) {
        this.plugin = plugin;
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (saveBtn != null) {
            saveBtn.setOnClickListener(new View.OnClickListener() { // from class: com.cncverse.SportzxSettings$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    SportzxSettings.onViewCreated$lambda$1(this.f$0, view2);
                }
            });
        }
    }
    ...
    public static final void onViewCreated$lambda$1(final SportzxSettings this$0, View it) {
        ...
        new AlertDialog.Builder(this$0.requireContext()).setTitle("Restart Required").setMessage("Changes have been saved. Do you want to restart the app to apply them?").setPositiveButton("Yes", new DialogInterface.OnClickListener() { // from class: com.cncverse.SportzxSettings$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                SportzxSettings.onViewCreated$lambda$1$1(this.f$0, dialogInterface, i);
            }
        }).setNegativeButton("No", new DialogInterface.OnClickListener() { // from class: com.cncverse.SportzxSettings$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                SportzxSettings.onViewCreated$lambda$1$2(dialogInterface, i);
            }
        }).show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onViewCreated$lambda$1$1(SportzxSettings this$0, DialogInterface dialogInterface, int i) {
        this$0.dismiss();
        this$0.restartApp();
    }
    ...
    private final RelativeLayout getPlaylistRow(final String playlistName) {
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.cncverse.SportzxSettings$$ExternalSyntheticLambda3
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                SportzxSettings.getPlaylistRow$lambda$3(this.f$0, playlistName, compoundButton, z);
            }
        });
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.cncverse.SportzxSettings$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SportzxSettings.getPlaylistRow$lambda$4(checkBox, view);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void getPlaylistRow$lambda$3(SportzxSettings this$0, String $playlistName, CompoundButton compoundButton, boolean checked) {
