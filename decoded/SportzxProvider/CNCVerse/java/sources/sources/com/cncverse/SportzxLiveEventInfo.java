...
public final /* data */ class SportzxLiveEventInfo {
    ...
    public static /* synthetic */ SportzxLiveEventInfo copy$default(SportzxLiveEventInfo sportzxLiveEventInfo, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, int i, Object obj) {
        if ((i & 1) != 0) {
            str = sportzxLiveEventInfo.teamA;
        }
        if ((i & 2) != 0) {
            str2 = sportzxLiveEventInfo.teamB;
        }
        if ((i & 4) != 0) {
            str3 = sportzxLiveEventInfo.teamAFlag;
        }
        if ((i & 8) != 0) {
            str4 = sportzxLiveEventInfo.teamBFlag;
        }
        if ((i & 16) != 0) {
            str5 = sportzxLiveEventInfo.eventCat;
        }
        if ((i & 32) != 0) {
            str6 = sportzxLiveEventInfo.eventName;
        }
        if ((i & 64) != 0) {
            str7 = sportzxLiveEventInfo.eventLogo;
        }
        if ((i & 128) != 0) {
            str8 = sportzxLiveEventInfo.isHot;
        }
        if ((i & 256) != 0) {
            str9 = sportzxLiveEventInfo.eventType;
        }
        if ((i & 512) != 0) {
            str10 = sportzxLiveEventInfo.startTime;
        }
        if ((i & 1024) != 0) {
            str11 = sportzxLiveEventInfo.endTime;
        }
        String str12 = str10;
        String str13 = str11;
        String str14 = str8;
        ...
        String str18 = str5;
        String str19 = str3;
        return sportzxLiveEventInfo.copy(str, str2, str19, str4, str18, str16, str17, str14, str15, str12, str13);
    }
    ...
    @NotNull
    public final SportzxLiveEventInfo copy(@Nullable String teamA, @Nullable String teamB, @Nullable String teamAFlag, @Nullable String teamBFlag, @Nullable String eventCat, @Nullable String eventName, @Nullable String eventLogo, @Nullable String isHot, @Nullable String eventType, @Nullable String startTime, @Nullable String endTime) {
        return new SportzxLiveEventInfo(teamA, teamB, teamAFlag, teamBFlag, eventCat, eventName, eventLogo, isHot, eventType, startTime, endTime);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof SportzxLiveEventInfo)) {
            return false;
        }
        SportzxLiveEventInfo sportzxLiveEventInfo = (SportzxLiveEventInfo) other;
        return Intrinsics.areEqual(this.teamA, sportzxLiveEventInfo.teamA) && Intrinsics.areEqual(this.teamB, sportzxLiveEventInfo.teamB) && Intrinsics.areEqual(this.teamAFlag, sportzxLiveEventInfo.teamAFlag) && Intrinsics.areEqual(this.teamBFlag, sportzxLiveEventInfo.teamBFlag) && Intrinsics.areEqual(this.eventCat, sportzxLiveEventInfo.eventCat) && Intrinsics.areEqual(this.eventName, sportzxLiveEventInfo.eventName) && Intrinsics.areEqual(this.eventLogo, sportzxLiveEventInfo.eventLogo) && Intrinsics.areEqual(this.isHot, sportzxLiveEventInfo.isHot) && Intrinsics.areEqual(this.eventType, sportzxLiveEventInfo.eventType) && Intrinsics.areEqual(this.startTime, sportzxLiveEventInfo.startTime) && Intrinsics.areEqual(this.endTime, sportzxLiveEventInfo.endTime);
    }
    ...
    public String toString() {
        ...
        sb.append("SportzxLiveEventInfo(teamA=").append(this.teamA).append(", teamB=").append(this.teamB).append(", teamAFlag=").append(this.teamAFlag).append(", teamBFlag=").append(this.teamBFlag).append(", eventCat=").append(this.eventCat).append(", eventName=").append(this.eventName).append(", eventLogo=").append(this.eventLogo).append(", isHot=").append(this.isHot).append(", eventType=").append(this.eventType).append(", startTime=").append(this.startTime).append(", endTime=").append(this.endTime).append(')');
        return sb.toString();
    }

    public SportzxLiveEventInfo(@Nullable String teamA, @Nullable String teamB, @Nullable String teamAFlag, @Nullable String teamBFlag, @Nullable String eventCat, @Nullable String eventName, @Nullable String eventLogo, @Nullable String isHot, @Nullable String eventType, @Nullable String startTime, @Nullable String endTime) {
        this.teamA = teamA;
        this.teamB = teamB;
