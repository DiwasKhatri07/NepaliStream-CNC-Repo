...
@DebugMetadata(c = "com.cncverse.SportzxLiveEventsProvider$loadLinks$2$2", f = "SportzxLiveEventsProvider.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, nl = {}, s = {}, v = 2)
final class SportzxLiveEventsProvider$loadLinks$2$2 extends SuspendLambda implements Function2<DrmExtractorLink, Continuation<? super Unit>, Object> {
    ...
    SportzxLiveEventsProvider$loadLinks$2$2(String str, String str2, Map<String, String> map, Continuation<? super SportzxLiveEventsProvider$loadLinks$2$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> sportzxLiveEventsProvider$loadLinks$2$2 = new SportzxLiveEventsProvider$loadLinks$2$2(this.$keyB64, this.$kidB64, this.$headers, continuation);
        sportzxLiveEventsProvider$loadLinks$2$2.L$0 = obj;
        return sportzxLiveEventsProvider$loadLinks$2$2;
    }
