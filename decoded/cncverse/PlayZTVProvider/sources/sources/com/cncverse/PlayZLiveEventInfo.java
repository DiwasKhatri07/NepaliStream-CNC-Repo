...
public final /* data */ class PlayZLiveEventInfo {
    ...
    public static /* synthetic */ PlayZLiveEventInfo copy$default(PlayZLiveEventInfo playZLiveEventInfo, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, int i, Object obj) {
        if ((i & 1) != 0) {
            str = playZLiveEventInfo.teamA;
        }
        if ((i & 2) != 0) {
            str2 = playZLiveEventInfo.teamB;
        }
        if ((i & 4) != 0) {
            str3 = playZLiveEventInfo.teamAFlag;
        }
        if ((i & 8) != 0) {
            str4 = playZLiveEventInfo.teamBFlag;
        }
        if ((i & 16) != 0) {
            str5 = playZLiveEventInfo.eventCat;
        }
        if ((i & 32) != 0) {
            str6 = playZLiveEventInfo.eventName;
        }
        if ((i & 64) != 0) {
            str7 = playZLiveEventInfo.eventLogo;
        }
        if ((i & 128) != 0) {
            str8 = playZLiveEventInfo.isHot;
        }
        if ((i & 256) != 0) {
            str9 = playZLiveEventInfo.eventType;
        }
        if ((i & 512) != 0) {
            str10 = playZLiveEventInfo.startTime;
        }
        if ((i & 1024) != 0) {
            str11 = playZLiveEventInfo.endTime;
        }
        String str12 = str10;
        String str13 = str11;
        String str14 = str8;
        ...
        String str18 = str5;
        String str19 = str3;
        return playZLiveEventInfo.copy(str, str2, str19, str4, str18, str16, str17, str14, str15, str12, str13);
    }
    ...
    @NotNull
    public final PlayZLiveEventInfo copy(@Nullable String teamA, @Nullable String teamB, @Nullable String teamAFlag, @Nullable String teamBFlag, @Nullable String eventCat, @Nullable String eventName, @Nullable String eventLogo, @Nullable String isHot, @Nullable String eventType, @Nullable String startTime, @Nullable String endTime) {
        return new PlayZLiveEventInfo(teamA, teamB, teamAFlag, teamBFlag, eventCat, eventName, eventLogo, isHot, eventType, startTime, endTime);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof PlayZLiveEventInfo)) {
            return false;
        }
        PlayZLiveEventInfo playZLiveEventInfo = (PlayZLiveEventInfo) other;
        return Intrinsics.areEqual(this.teamA, playZLiveEventInfo.teamA) && Intrinsics.areEqual(this.teamB, playZLiveEventInfo.teamB) && Intrinsics.areEqual(this.teamAFlag, playZLiveEventInfo.teamAFlag) && Intrinsics.areEqual(this.teamBFlag, playZLiveEventInfo.teamBFlag) && Intrinsics.areEqual(this.eventCat, playZLiveEventInfo.eventCat) && Intrinsics.areEqual(this.eventName, playZLiveEventInfo.eventName) && Intrinsics.areEqual(this.eventLogo, playZLiveEventInfo.eventLogo) && Intrinsics.areEqual(this.isHot, playZLiveEventInfo.isHot) && Intrinsics.areEqual(this.eventType, playZLiveEventInfo.eventType) && Intrinsics.areEqual(this.startTime, playZLiveEventInfo.startTime) && Intrinsics.areEqual(this.endTime, playZLiveEventInfo.endTime);
    }
    ...
    public String toString() {
        ...
        sb.append("PlayZLiveEventInfo(teamA=").append(this.teamA).append(", teamB=").append(this.teamB).append(", teamAFlag=").append(this.teamAFlag).append(", teamBFlag=").append(this.teamBFlag).append(", eventCat=").append(this.eventCat).append(", eventName=").append(this.eventName).append(", eventLogo=").append(this.eventLogo).append(", isHot=").append(this.isHot).append(", eventType=").append(this.eventType).append(", startTime=").append(this.startTime).append(", endTime=").append(this.endTime).append(')');
        return sb.toString();
    }

    public PlayZLiveEventInfo(@Nullable String teamA, @Nullable String teamB, @Nullable String teamAFlag, @Nullable String teamBFlag, @Nullable String eventCat, @Nullable String eventName, @Nullable String eventLogo, @Nullable String isHot, @Nullable String eventType, @Nullable String startTime, @Nullable String endTime) {
        this.teamA = teamA;
        this.teamB = teamB;
