...
final class DudefilmsPlugin$Companion$getDomains$1 extends ContinuationImpl {
    ...
    final /* synthetic */ DudefilmsPlugin.Companion this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DudefilmsPlugin$Companion$getDomains$1(DudefilmsPlugin.Companion companion, Continuation<? super DudefilmsPlugin$Companion$getDomains$1> continuation) {
        super(continuation);
