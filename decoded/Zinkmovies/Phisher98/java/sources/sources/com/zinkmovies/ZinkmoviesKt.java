...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\u001a\u0016\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u0086@¢\u0006\u0002\u0010\u0004¨\u0006\u0005"}, d2 = {"showCFBypassDialogAndWait", "", "url", "", "(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "Zinkmovies"}, k = 2, mv = {2, 4, 0}, xi = 48)
public final class ZinkmoviesKt {

    /* JADX INFO: renamed from: com.zinkmovies.ZinkmoviesKt$showCFBypassDialogAndWait$2 */
    /* JADX INFO: compiled from: Zinkmovies.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 4, 0}, xi = 48)
    @DebugMetadata(c = "com.zinkmovies.ZinkmoviesKt$showCFBypassDialogAndWait$2", f = "Zinkmovies.kt", i = {0}, l = {719}, m = "invokeSuspend", n = {"$this$withContext"}, nl = {719}, s = {"L$0"}, v = 2)
    @SourceDebugExtension({"SMAP\nZinkmovies.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Zinkmovies.kt\ncom/zinkmovies/ZinkmoviesKt$showCFBypassDialogAndWait$2\n+ 2 CancellableContinuation.kt\nkotlinx/coroutines/CancellableContinuationKt\n*L\n1#1,718:1\n433#2,10:719\n*S KotlinDebug\n*F\n+ 1 Zinkmovies.kt\ncom/zinkmovies/ZinkmoviesKt$showCFBypassDialogAndWait$2\n*L\n83#1:719,10\n*E\n"})
    static final class C00202 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> c00202 = new C00202(this.$url, continuation);
            c00202.L$0 = obj;
            return c00202;
        }
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (activity == null || activity.isFinishing() || activity.isDestroyed()) {
                        if (rawActivity != null) {
                            Toast.makeText(rawActivity, "Zinkmovies: Cloudflare challenge active.", 1).show();
                        }
                        ...
                        final CloudflareWebViewDialog dialog = new CloudflareWebViewDialog(str, new Function1<Boolean, Unit>() { // from class: com.zinkmovies.ZinkmoviesKt$showCFBypassDialogAndWait$2$1$dialog$1
                            ...
                            public final void invoke(boolean success) {
                                ZinkmoviesKt.C00202.invokeSuspend$lambda$0$safeResume(resumed, continuation, success);
                            }
                        }, false, 4, null);
                        continuation.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: com.zinkmovies.ZinkmoviesKt$showCFBypassDialogAndWait$2$1$2
                            public /* bridge */ /* synthetic */ Object invoke(Object p1) {
                                invoke((Throwable) p1);
                                return Unit.INSTANCE;
                            }
                            ...
                            public final void invoke(Throwable it) {
                                ...
                                appCompatActivity.runOnUiThread(new Runnable() { // from class: com.zinkmovies.ZinkmoviesKt$showCFBypassDialogAndWait$2$1$2.1
                        ...
                        dialog.show(activity2.getSupportFragmentManager(), "zinkmovies_cf_bypass_auto");
                    }
    ...
    public static final Object showCFBypassDialogAndWait(@NotNull String url, @NotNull Continuation<? super Boolean> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain(), new C00202(url, null), continuation);
    }
}
