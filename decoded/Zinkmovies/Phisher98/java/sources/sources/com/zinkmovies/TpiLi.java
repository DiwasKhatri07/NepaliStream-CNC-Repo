...
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003JH\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u00052\b\u0010\u0011\u001a\u0004\u0018\u00010\u00052\u0012\u0010\u0012\u001a\u000e\u0012\u0004\u0012\u00020\u0014\u0012\u0004\u0012\u00020\u000f0\u00132\u0012\u0010\u0015\u001a\u000e\u0012\u0004\u0012\u00020\u0016\u0012\u0004\u0012\u00020\u000f0\u0013H\u0096@¢\u0006\u0002\u0010\u0017R\u0014\u0010\u0004\u001a\u00020\u0005X\u0096D¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0014\u0010\b\u001a\u00020\u0005X\u0096D¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\u0007R\u0014\u0010\n\u001a\u00020\u000bX\u0096D¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\r¨\u0006\u0018"}, d2 = {"Lcom/zinkmovies/TpiLi;", "Lcom/lagradost/cloudstream3/utils/ExtractorApi;", "<init>", "()V", "name", "", "getName", "()Ljava/lang/String;", "mainUrl", "getMainUrl", "requiresReferer", "", "getRequiresReferer", "()Z", "getUrl", "", "url", "referer", "subtitleCallback", "Lkotlin/Function1;", "Lcom/lagradost/cloudstream3/SubtitleFile;", "callback", "Lcom/lagradost/cloudstream3/utils/ExtractorLink;", "(Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "Zinkmovies"}, k = 1, mv = {2, 4, 0}, xi = 48)
public final class TpiLi extends ExtractorApi {
    private final boolean requiresReferer;

    @NotNull
    private final String name = "TpiLi";

    @NotNull
    private final String mainUrl = "https://(tpi\\.li|oii\\.la)";

    /* JADX INFO: renamed from: com.zinkmovies.TpiLi$getUrl$1 */
    /* JADX INFO: compiled from: Extractors.kt */
    ...
    static final class C00091 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            return TpiLi.this.getUrl(null, null, null, null, (Continuation) this);
        }
    }
    ...
    public Object getUrl(@NotNull String url, @Nullable String referer, @NotNull Function1<? super SubtitleFile, Unit> function1, @NotNull Function1<? super ExtractorLink, Unit> function2, @NotNull Continuation<? super Unit> continuation) {
        ...
        switch (c00091.label) {
            case 0:
                ...
                c00091.L$2 = function1;
                c00091.L$3 = function2;
                c00091.label = 1;
                objBypassShortlink = UtilsKt.bypassShortlink(url, c00091);
                ...
                c00091.L$1 = SpillingKt.nullOutSpilledVariable(referer);
                c00091.L$2 = SpillingKt.nullOutSpilledVariable(function1);
                c00091.L$3 = SpillingKt.nullOutSpilledVariable(function2);
                c00091.L$4 = SpillingKt.nullOutSpilledVariable(finalUrl);
                c00091.label = 2;
                if (ExtractorApiKt.loadExtractor(finalUrl, url, function1, function2, c00091) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Unit.INSTANCE;
            case 1:
                function2 = (Function1) c00091.L$3;
                function1 = (Function1) c00091.L$2;
                referer = (String) c00091.L$1;
                url = (String) c00091.L$0;
                ResultKt.throwOnFailure($result);
                objBypassShortlink = $result;
                finalUrl = (String) objBypassShortlink;
                if (Intrinsics.areEqual(finalUrl, url)) {
                    break;
                }
                return Unit.INSTANCE;
            case 2:
