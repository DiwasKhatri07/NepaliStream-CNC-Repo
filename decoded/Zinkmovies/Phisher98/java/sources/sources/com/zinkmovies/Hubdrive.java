...
public final class Hubdrive extends ExtractorApi {
    ...
    /* JADX INFO: renamed from: com.zinkmovies.Hubdrive$getUrl$1 */
    /* JADX INFO: compiled from: Extractors.kt */
    ...
    public Object getUrl(@NotNull String url, @Nullable String referer, @NotNull Function1<? super SubtitleFile, Unit> function1, @NotNull Function1<? super ExtractorLink, Unit> function2, @NotNull Continuation<? super Unit> continuation) {
        ...
        switch (c00082.label) {
            case 0:
                ...
                c00082.L$2 = function1;
                c00082.L$3 = function2;
                c00082.label = 1;
                obj = coroutine_suspended;
                z = true;
                obj2 = Requests.get$default(app, url, (Map) null, (String) null, (Map) null, (Map) null, false, 0, (TimeUnit) null, 5000L, (Interceptor) null, false, (ResponseParser) null, c00082, 3838, (Object) null);
                c00082 = c00082;
                if (obj2 == obj) {
                    return obj;
                }
                ...
                if (StringsKt.contains(href, "hubcloud", z)) {
                    ...
                    c00082.L$4 = SpillingKt.nullOutSpilledVariable(href);
                    c00082.label = 3;
                    if (ExtractorApiKt.loadExtractor(href, "HubDrive", function3, function4, c00082) == obj) {
                        return obj;
                    }
                ...
                c00082.L$4 = SpillingKt.nullOutSpilledVariable(href);
                c00082.label = 2;
                $result = hubCloud.getUrl(href, "HubDrive", function3, function4, c00082);
                if ($result == obj) {
                    return obj;
                }
                return $result;
            case 1:
                Function1<? super ExtractorLink, Unit> function5 = (Function1) c00082.L$3;
                function3 = (Function1) c00082.L$2;
                ...
                c00082.L$4 = SpillingKt.nullOutSpilledVariable(href);
                c00082.label = 2;
                $result = hubCloud2.getUrl(href, "HubDrive", function3, function4, c00082);
                if ($result == obj) {
                    return obj;
                }
                return $result;
