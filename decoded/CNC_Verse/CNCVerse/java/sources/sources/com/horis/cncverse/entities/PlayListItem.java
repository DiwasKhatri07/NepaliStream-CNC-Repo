...
public final /* data */ class PlayListItem {
    ...
    @NotNull
    public final PlayListItem copy(@Nullable String image, @Nullable String image2, @NotNull List<Source> sources, @Nullable List<Tracks> tracks, @NotNull String title) {
    ...
    public int hashCode() {
        return ((((((((this.image == null ? 0 : this.image.hashCode()) * 31) + (this.image2 == null ? 0 : this.image2.hashCode())) * 31) + this.sources.hashCode()) * 31) + (this.tracks != null ? this.tracks.hashCode() : 0)) * 31) + this.title.hashCode();
    }
    ...
    public PlayListItem(@Nullable String image, @Nullable String image2, @NotNull List<Source> list, @Nullable List<Tracks> list2, @NotNull String title) {
        this.image = image;
        this.image2 = image2;
        this.sources = list;
        this.tracks = list2;
