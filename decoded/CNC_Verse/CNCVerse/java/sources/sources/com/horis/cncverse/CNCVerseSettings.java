...
public final class CNCVerseSettings extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MaterialButton $this$onViewCreated_u24lambda_u241 = new MaterialButton(requireContext());
        $this$onViewCreated_u24lambda_u241.setText("Clear All Cache");
        $this$onViewCreated_u24lambda_u241.setAllCaps(false);
        $this$onViewCreated_u24lambda_u241.setOnClickListener(new View.OnClickListener() { // from class: com.horis.cncverse.CNCVerseSettings$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                CNCVerseSettings.onViewCreated$lambda$1$0(this.f$0, view2);
            }
        });
        LinearLayout.LayoutParams $this$onViewCreated_u24lambda_u241_u241 = new LinearLayout.LayoutParams(-1, -2);
        $this$onViewCreated_u24lambda_u241_u241.topMargin = 32;
        $this$onViewCreated_u24lambda_u241.setLayoutParams($this$onViewCreated_u24lambda_u241_u241);
        if (scrollView != null) {
            scrollView.addView((View) $this$onViewCreated_u24lambda_u241);
        }
        if (saveBtn != null) {
            saveBtn.setOnClickListener(new View.OnClickListener() { // from class: com.horis.cncverse.CNCVerseSettings$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    CNCVerseSettings.onViewCreated$lambda$2(this.f$0, view2);
                }
            });
        }
    }
    ...
    public static final void onViewCreated$lambda$1$0(CNCVerseSettings this$0, View it) {
        NetflixMirrorStorage.INSTANCE.init(this$0.requireContext());
        NetflixMirrorStorage.INSTANCE.clearAll();
        CookieManager.getInstance().removeAllCookies(null);
        CookieManager.getInstance().flush();
        CommonActivity.showToast$default(CommonActivity.INSTANCE, "All cache and tokens cleared", (Integer) null, 2, (Object) null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onViewCreated$lambda$2(final CNCVerseSettings this$0, View it) {
        SharedPreferences sharedPreferences = this$0.sharedPref;
        SharedPreferences.Editor $this$onViewCreated_u24lambda_u242_u240 = sharedPreferences != null ? sharedPreferences.edit() : null;
        if ($this$onViewCreated_u24lambda_u242_u240 != null) {
            $this$onViewCreated_u24lambda_u242_u240.clear();
        }
        Iterable $this$forEach$iv = this$0.studios;
        for (Object element$iv : $this$forEach$iv) {
            StudioOption option = (StudioOption) element$iv;
            if ($this$onViewCreated_u24lambda_u242_u240 != null) {
                $this$onViewCreated_u24lambda_u242_u240.putBoolean(option.getKey(), this$0.enabledStudios.contains(option.getKey()));
            }
        }
        if ($this$onViewCreated_u24lambda_u242_u240 != null) {
        ...
        new AlertDialog.Builder(this$0.requireContext()).setTitle("Restart Required").setMessage("Changes have been saved. Do you want to restart the app to apply them?").setPositiveButton("Yes", new DialogInterface.OnClickListener() { // from class: com.horis.cncverse.CNCVerseSettings$$ExternalSyntheticLambda2
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                CNCVerseSettings.onViewCreated$lambda$2$1(this.f$0, dialogInterface, i);
            }
            ...
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                CNCVerseSettings.onViewCreated$lambda$2$2(dialogInterface, i);
            }
        }).show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onViewCreated$lambda$2$1(CNCVerseSettings this$0, DialogInterface dialogInterface, int i) {
        this$0.dismiss();
        this$0.restartApp();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onViewCreated$lambda$2$2(DialogInterface dialog, int i) {
        dialog.dismiss();
