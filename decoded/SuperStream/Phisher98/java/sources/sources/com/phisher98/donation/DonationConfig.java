...
public final /* data */ class DonationConfig {
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((((DonationConfig$$ExternalSyntheticBackport0.m9m(this.enabled) * 31) + this.extensionName.hashCode()) * 31) + this.month.hashCode()) * 31) + this.title.hashCode()) * 31) + this.description.hashCode()) * 31) + this.currency.hashCode()) * 31) + DonationConfig$$ExternalSyntheticBackport1.m10m(this.targetAmount)) * 31) + DonationConfig$$ExternalSyntheticBackport1.m10m(this.currentAmount)) * 31) + this.supportersCount) * 31) + this.primaryDonateUrl.hashCode()) * 31) + this.primaryButtonText.hashCode()) * 31) + this.secondaryDonateUrl.hashCode()) * 31) + this.secondaryButtonText.hashCode()) * 31) + this.cooldownHours) * 31) + this.cooldownScope.hashCode();
    }
    ...
    /* JADX INFO: compiled from: DonationData.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/phisher98/donation/DonationConfig$Companion;", "", "<init>", "()V", "fromJson", "Lcom/phisher98/donation/DonationConfig;", "jsonStr", "", "SuperStream"}, k = 1, mv = {2, 4, 0}, xi = 48)
